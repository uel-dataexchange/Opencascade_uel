...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom_HArray1OfBoundedSurface,Storage_CallBack)

class ShapeSchema_PColPGeom_HArray1OfBoundedSurface : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom_HArray1OfBoundedSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom_HArray1OfBoundedSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom_HArray1OfBoundedSurface)
};
#endif
