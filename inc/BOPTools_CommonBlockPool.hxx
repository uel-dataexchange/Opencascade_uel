...
#define _BOPTools_CommonBlockPool_HeaderFile
...
~BOPTools_CommonBlockPool()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_ListOfCommonBlock& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_ListOfCommonBlock& Value(const Standard_Integer Index) const;
   const BOPTools_ListOfCommonBlock& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_ListOfCommonBlock& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CommonBlockPool(const BOPTools_CommonBlockPool& AnArray);
  
  Standard_EXPORT     BOPTools_CommonBlockPool& Assign(const BOPTools_CommonBlockPool& Other) ;
    BOPTools_CommonBlockPool& operator =(const BOPTools_CommonBlockPool& Other) 
{
  return Assign(Other);
}
