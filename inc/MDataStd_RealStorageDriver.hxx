...
#ifndef _MDataStd_RealStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_RealStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_RealStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Real from TDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_RealStorageDriver)
