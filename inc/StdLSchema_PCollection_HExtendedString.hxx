...
DEFINE_STANDARD_HANDLE(StdLSchema_PCollection_HExtendedString,Storage_CallBack)

class StdLSchema_PCollection_HExtendedString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PCollection_HExtendedString)
};
#endif
