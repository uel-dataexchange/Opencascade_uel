...
#ifndef _IGESGeom_ToolTrimmedSurface_HeaderFile
#define _IGESGeom_ToolTrimmedSurface_HeaderFile
...
//! Tool to work on a TrimmedSurface. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_TrimmedSurface)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESGeom_TrimmedSurface)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a TrimmedSurface <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESGeom_TrimmedSurface)& ent,Interface_EntityIterator& iter) const;
  //! Returns specific DirChecker <br>
  Standard_EXPORT     IGESData_DirChecker DirChecker(const Handle(IGESGeom_TrimmedSurface)& ent) const;
