...
#define _Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint_HeaderFile
...
DEFINE_STANDARD_HANDLE(IntSurf_SequenceNodeOfSequenceOfInteriorPoint,TCollection_SeqNode)
