...
#ifndef _MDataStd_VariableRetrievalDriver_HeaderFile
#define _MDataStd_VariableRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_VariableRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_VariableRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Variable from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_VariableRetrievalDriver)
