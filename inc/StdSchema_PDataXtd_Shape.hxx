...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Shape,Storage_CallBack)

class StdSchema_PDataXtd_Shape : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Shape() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Shape)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Shape)
};
#endif
