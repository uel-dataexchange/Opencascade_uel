...
#ifndef _MDF_ReferenceStorageDriver_HeaderFile
#define _MDF_ReferenceStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDF_ReferenceStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MDF_ReferenceStorageDriver)
