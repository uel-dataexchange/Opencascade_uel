...
DEFINE_STANDARD_HANDLE(StdSchema_PColStd_HArray1OfInteger,Storage_CallBack)

class StdSchema_PColStd_HArray1OfInteger : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PColStd_HArray1OfInteger)
};
#endif
