...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_VectorWithMagnitude,Storage_CallBack)

class ShapeSchema_PGeom_VectorWithMagnitude : public Storage_CallBack {
public:
  ShapeSchema_PGeom_VectorWithMagnitude() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_VectorWithMagnitude)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_VectorWithMagnitude)
};
#endif
