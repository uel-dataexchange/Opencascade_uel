...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_Polygon3D,Storage_CallBack)

class ShapeSchema_PBRep_Polygon3D : public Storage_CallBack {
public:
  ShapeSchema_PBRep_Polygon3D() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_Polygon3D)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_Polygon3D)
};
#endif
