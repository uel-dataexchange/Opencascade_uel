...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_CartesianPoint,Storage_CallBack)

class ShapeSchema_PGeom_CartesianPoint : public Storage_CallBack {
public:
  ShapeSchema_PGeom_CartesianPoint() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_CartesianPoint)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_CartesianPoint)
};
#endif
