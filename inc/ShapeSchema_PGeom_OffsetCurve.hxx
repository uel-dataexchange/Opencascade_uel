...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_OffsetCurve,Storage_CallBack)

class ShapeSchema_PGeom_OffsetCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_OffsetCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_OffsetCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_OffsetCurve)
};
#endif
