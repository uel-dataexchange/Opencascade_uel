...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_RealList,Storage_CallBack)

class StdLSchema_PDataStd_RealList : public Storage_CallBack {
public:
  StdLSchema_PDataStd_RealList() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_RealList)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_RealList)
};
#endif
