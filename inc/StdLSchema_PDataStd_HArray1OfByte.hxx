...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_HArray1OfByte,Storage_CallBack)

class StdLSchema_PDataStd_HArray1OfByte : public Storage_CallBack {
public:
  StdLSchema_PDataStd_HArray1OfByte() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_HArray1OfByte)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_HArray1OfByte)
};
#endif
