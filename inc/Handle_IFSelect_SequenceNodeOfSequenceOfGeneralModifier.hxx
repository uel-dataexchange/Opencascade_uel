...
#define _Handle_IFSelect_SequenceNodeOfSequenceOfGeneralModifier_HeaderFile
...
DEFINE_STANDARD_HANDLE(IFSelect_SequenceNodeOfSequenceOfGeneralModifier,TCollection_SeqNode)
