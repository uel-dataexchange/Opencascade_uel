...
DEFINE_STANDARD_HANDLE(ShapeSchema_PMMgt_PManaged,Storage_CallBack)

class ShapeSchema_PMMgt_PManaged : public Storage_CallBack {
public:
  ShapeSchema_PMMgt_PManaged() {}
  Standard_EXPORT static void SAdd(const Handle(PMMgt_PManaged)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PMMgt_PManaged)
};
#endif
