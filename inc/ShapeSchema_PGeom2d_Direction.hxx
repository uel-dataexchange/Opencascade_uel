...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Direction,Storage_CallBack)

class ShapeSchema_PGeom2d_Direction : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Direction() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Direction)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Direction)
};
#endif
