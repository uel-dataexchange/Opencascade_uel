...
#ifndef _IGESGeom_ToolOffsetSurface_HeaderFile
#define _IGESGeom_ToolOffsetSurface_HeaderFile
...
//! Tool to work on a OffsetSurface. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_OffsetSurface)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESGeom_OffsetSurface)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a OffsetSurface <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESGeom_OffsetSurface)& ent,Interface_EntityIterator& iter) const;
