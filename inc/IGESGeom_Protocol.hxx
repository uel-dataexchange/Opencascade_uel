...
#ifndef _IGESGeom_Protocol_HeaderFile
#define _IGESGeom_Protocol_HeaderFile
...
//! Description of Protocol for IGESGeom <br>
class IGESGeom_Protocol : public IGESData_Protocol {

public:

  
  Standard_EXPORT   IGESGeom_Protocol();
...
//!           consider the same Type as the Protocol defines) <br>
  ...
  DEFINE_STANDARD_RTTI(IGESGeom_Protocol)
