...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_CurveOnClosedSurface,Storage_CallBack)

class ShapeSchema_PBRep_CurveOnClosedSurface : public Storage_CallBack {
public:
  ShapeSchema_PBRep_CurveOnClosedSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_CurveOnClosedSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_CurveOnClosedSurface)
};
#endif
