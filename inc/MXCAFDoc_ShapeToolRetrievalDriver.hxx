...
#ifndef _MXCAFDoc_ShapeToolRetrievalDriver_HeaderFile
#define _MXCAFDoc_ShapeToolRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_ShapeToolRetrievalDriver_HeaderFile
#include <Handle_MXCAFDoc_ShapeToolRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_ShapeToolRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_ShapeToolRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_ShapeToolRetrievalDriver)
