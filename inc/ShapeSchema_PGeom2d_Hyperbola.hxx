...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Hyperbola,Storage_CallBack)

class ShapeSchema_PGeom2d_Hyperbola : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Hyperbola() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Hyperbola)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Hyperbola)
};
#endif
