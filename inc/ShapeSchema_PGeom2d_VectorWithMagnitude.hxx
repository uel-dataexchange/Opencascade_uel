...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_VectorWithMagnitude,Storage_CallBack)

class ShapeSchema_PGeom2d_VectorWithMagnitude : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_VectorWithMagnitude() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_VectorWithMagnitude)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_VectorWithMagnitude)
};
#endif
