...
#ifndef _IGESSolid_ToolFace_HeaderFile
#define _IGESSolid_ToolFace_HeaderFile
...
//! Tool to work on a Face. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_Face)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Face <ent>, from <br>
