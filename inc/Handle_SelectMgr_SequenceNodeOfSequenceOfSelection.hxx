...
#define _Handle_SelectMgr_SequenceNodeOfSequenceOfSelection_HeaderFile
...
DEFINE_STANDARD_HANDLE(SelectMgr_SequenceNodeOfSequenceOfSelection,TCollection_SeqNode)
