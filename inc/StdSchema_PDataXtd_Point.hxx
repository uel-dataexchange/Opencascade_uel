...
#endif
#ifndef _Handle_PDataXtd_Point_HeaderFile
...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Point,Storage_CallBack)

class StdSchema_PDataXtd_Point : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Point() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Point)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Point)
};
#endif
