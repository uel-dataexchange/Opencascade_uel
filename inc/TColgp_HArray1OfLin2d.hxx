...
public:
  ...
  Standard_EXPORT   TColgp_HArray1OfLin2d(const Standard_Integer Low,const Standard_Integer Up);
  
  Standard_EXPORT   TColgp_HArray1OfLin2d(const Standard_Integer Low,const Standard_Integer Up,const gp_Lin2d& V);
