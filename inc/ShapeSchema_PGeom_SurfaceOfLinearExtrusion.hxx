...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_SurfaceOfLinearExtrusion,Storage_CallBack)

class ShapeSchema_PGeom_SurfaceOfLinearExtrusion : public Storage_CallBack {
public:
  ShapeSchema_PGeom_SurfaceOfLinearExtrusion() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_SurfaceOfLinearExtrusion)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_SurfaceOfLinearExtrusion)
};
#endif
