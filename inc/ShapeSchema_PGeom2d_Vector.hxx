...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Vector,Storage_CallBack)

class ShapeSchema_PGeom2d_Vector : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Vector() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Vector)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Vector)
};
#endif
