...
#define _PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d_HeaderFile
...
public:
  ...
  Standard_EXPORT   PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d(const gp_Circ2d& aValue);
  
  Standard_EXPORT     void SetValue(const gp_Circ2d& aValue) ;
  
  Standard_EXPORT     Standard_Address Value() const;

PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d(const Storage_stCONSTclCOM& a) : PStandard_ArrayNode(a)
{
  
}
    const gp_Circ2d& _CSFDB_GetPColgp_VArrayNodeOfFieldOfHArray1OfCirc2dmyValue() const { return myValue; }



  DEFINE_STANDARD_RTTI(PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d)
