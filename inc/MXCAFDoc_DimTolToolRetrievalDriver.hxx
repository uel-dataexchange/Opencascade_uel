...
#ifndef _MXCAFDoc_DimTolToolRetrievalDriver_HeaderFile
#define _MXCAFDoc_DimTolToolRetrievalDriver_HeaderFile
...
#include <Handle_MXCAFDoc_DimTolToolRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_DimTolToolRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_DimTolToolRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_DimTolTool <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_DimTolToolRetrievalDriver)
