...
#define _Handle_BRepOffsetAPI_SequenceNodeOfSequenceOfSequenceOfReal_HeaderFile
...
DEFINE_STANDARD_HANDLE(BRepOffsetAPI_SequenceNodeOfSequenceOfSequenceOfReal,TCollection_SeqNode)
