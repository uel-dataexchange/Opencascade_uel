...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PointOnSurface,Storage_CallBack)

class ShapeSchema_PBRep_PointOnSurface : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PointOnSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PointOnSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PointOnSurface)
};
#endif
