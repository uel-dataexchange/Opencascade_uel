...
#define _PColgp_FieldOfHArray2OfCirc2d_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColgp_FieldOfHArray2OfCirc2d);
...
public:
  ...
  Standard_EXPORT   PColgp_FieldOfHArray2OfCirc2d(const Standard_Integer Size);
  
  Standard_EXPORT   PColgp_FieldOfHArray2OfCirc2d(const PColgp_FieldOfHArray2OfCirc2d& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColgp_FieldOfHArray2OfCirc2d& Other) ;
