...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_SweptSurface,Storage_CallBack)

class ShapeSchema_PGeom_SweptSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_SweptSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_SweptSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_SweptSurface)
};
#endif
