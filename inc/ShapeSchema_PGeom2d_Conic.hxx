...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Conic,Storage_CallBack)

class ShapeSchema_PGeom2d_Conic : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Conic() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Conic)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Conic)
};
#endif
