...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_ShapeTool,Storage_CallBack)

class XCAFSchema_PXCAFDoc_ShapeTool : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_ShapeTool() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_ShapeTool)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_ShapeTool)
};
#endif
