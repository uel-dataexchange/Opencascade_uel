...
#ifndef _IGESSolid_ToolEllipsoid_HeaderFile
#define _IGESSolid_ToolEllipsoid_HeaderFile
...
//! Tool to work on a Ellipsoid. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_Ellipsoid)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Ellipsoid <ent>, from <br>
