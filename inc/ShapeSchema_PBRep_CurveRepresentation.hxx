...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_CurveRepresentation,Storage_CallBack)

class ShapeSchema_PBRep_CurveRepresentation : public Storage_CallBack {
public:
  ShapeSchema_PBRep_CurveRepresentation() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_CurveRepresentation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_CurveRepresentation)
};
#endif
