...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_ReferenceArray,Storage_CallBack)

class StdLSchema_PDataStd_ReferenceArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_ReferenceArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_ReferenceArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_ReferenceArray)
};
#endif
