...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray2OfDir2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray2OfDir2d,PStandard_ArrayNode)
