...
public:
  ...
  Standard_EXPORT   TColgp_HArray1OfVec2d(const Standard_Integer Low,const Standard_Integer Up);
  
  Standard_EXPORT   TColgp_HArray1OfVec2d(const Standard_Integer Low,const Standard_Integer Up,const gp_Vec2d& V);
