...
#define _TopOpeBRepTool_IndexedDataMapOfShapeconnexity_HeaderFile
...
public:
  ...
  Standard_EXPORT     TopOpeBRepTool_IndexedDataMapOfShapeconnexity& Assign(const TopOpeBRepTool_IndexedDataMapOfShapeconnexity& Other) ;
...
~TopOpeBRepTool_IndexedDataMapOfShapeconnexity()
{
  ...
  Standard_EXPORT     Standard_Integer Add(const TopoDS_Shape& K,const TopOpeBRepTool_connexity& I) ;
  
  Standard_EXPORT     void Substitute(const Standard_Integer I,const TopoDS_Shape& K,const TopOpeBRepTool_connexity& T) ;
  ...
  Standard_EXPORT    const TopOpeBRepTool_connexity& FindFromIndex(const Standard_Integer I) const;
   const TopOpeBRepTool_connexity& operator ()(const Standard_Integer I) const
{
  return FindFromIndex(I);
}
  
  Standard_EXPORT     TopOpeBRepTool_connexity& ChangeFromIndex(const Standard_Integer I) ;
...
private:
  ...
  Standard_EXPORT   TopOpeBRepTool_IndexedDataMapOfShapeconnexity(const TopOpeBRepTool_IndexedDataMapOfShapeconnexity& Other);
