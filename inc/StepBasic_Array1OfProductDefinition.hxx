...
public:
  ...
  Standard_EXPORT   StepBasic_Array1OfProductDefinition(const Handle(StepBasic_ProductDefinition)& Item,const Standard_Integer Low,const Standard_Integer Up);
