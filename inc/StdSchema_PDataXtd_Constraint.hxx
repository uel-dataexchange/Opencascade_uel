...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Constraint,Storage_CallBack)

class StdSchema_PDataXtd_Constraint : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Constraint() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Constraint)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Constraint)
};
#endif
