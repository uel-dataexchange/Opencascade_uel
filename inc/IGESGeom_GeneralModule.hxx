...
//! Definition of General Services for IGESGeom (specific part) <br>
//!           This Services comprise : Shared & Implied Lists, Copy, Check <br>
class IGESGeom_GeneralModule : public IGESData_GeneralModule {

public:

  //! Creates a GeneralModule from IGESGeom and puts it into GeneralLib <br>
...
//!           Shape for all, but Drawing for : <br>
//!           Flash;  Point with a symbol;  Plane with a symbol <br>
  ...
  DEFINE_STANDARD_RTTI(IGESGeom_GeneralModule)
