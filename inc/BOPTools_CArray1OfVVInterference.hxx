...
#define _BOPTools_CArray1OfVVInterference_HeaderFile
...
~BOPTools_CArray1OfVVInterference()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_VVInterference& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_VVInterference& Value(const Standard_Integer Index) const;
   const BOPTools_VVInterference& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_VVInterference& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CArray1OfVVInterference(const BOPTools_CArray1OfVVInterference& AnArray);
  
  Standard_EXPORT     BOPTools_CArray1OfVVInterference& Assign(const BOPTools_CArray1OfVVInterference& Other) ;
    BOPTools_CArray1OfVVInterference& operator =(const BOPTools_CArray1OfVVInterference& Other) 
{
  return Assign(Other);
}
