...
//! Read & Write tool for FeaMaterialPropertyRepresentationItem <br>
...
public:
  ...
  //! Reads FeaMaterialPropertyRepresentationItem <br>
  ...
  //! Writes FeaMaterialPropertyRepresentationItem <br>
