...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_IntPackedMap_1,Storage_CallBack)

class StdLSchema_PDataStd_IntPackedMap_1 : public Storage_CallBack {
public:
  StdLSchema_PDataStd_IntPackedMap_1() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_IntPackedMap_1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_IntPackedMap_1)
};
#endif
