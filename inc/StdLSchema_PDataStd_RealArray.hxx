...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_RealArray,Storage_CallBack)

class StdLSchema_PDataStd_RealArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_RealArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_RealArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_RealArray)
};
#endif
