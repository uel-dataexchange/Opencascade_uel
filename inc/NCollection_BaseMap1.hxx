...
#ifndef NCollection_BaseMap1_HeaderFile
#define NCollection_BaseMap1_HeaderFile
...
typedef void (* NCollection_DelMapNode1) 
...
public:
  ...
  protected:
    ...
    //! Constructor
    Iterator (const NCollection_BaseMap1& theMap) :
  ...
  public:
    //! Initialize
    void Initialize (const NCollection_BaseMap1& theMap)
    {
      myNbBuckets = theMap.myNbBuckets;
      myBuckets = theMap.myData1;
      myBucket = -1;
  ...
  protected:
    ...
    NCollection_ListNode1 **myBuckets;   //!< Location in memory 
    Standard_Integer       myBucket;    //!< Current bucket
    NCollection_ListNode1 * myNode;      //!< Current node
  };
 ...
 protected:
  ...
  //! Constructor
  NCollection_BaseMap1 (const Standard_Integer NbBuckets,
  ...
  //! Destroy
  Standard_EXPORT void Destroy(NCollection_DelMapNode1 fDel,
  ...
  void exchangeMapsData (NCollection_BaseMap1& theOther)
  {
 ...
 protected:
  ...
  NCollection_ListNode1 ** myData1;
  NCollection_ListNode1 ** myData2;
