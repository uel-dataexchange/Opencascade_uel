...
#ifndef _MDataXtd_PlaneRetrievalDriver_HeaderFile
#define _MDataXtd_PlaneRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataXtd_PlaneRetrievalDriver_HeaderFile
#include <Handle_MDataXtd_PlaneRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_PlaneRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Plane from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_PlaneRetrievalDriver)
