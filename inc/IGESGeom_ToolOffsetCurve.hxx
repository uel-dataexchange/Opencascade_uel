...
//! Tool to work on a OffsetCurve. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  ...
  //! Lists the Entities shared by a OffsetCurve <ent>, from <br>
//!           its specific (own) parameters <br>
  ...
  //! Sets automatic unambiguous Correction on a OffsetCurve <br>
//!           (if OffsetType is not 3, OffsetFunction is cleared) <br>
