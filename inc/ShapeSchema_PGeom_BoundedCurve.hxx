...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BoundedCurve,Storage_CallBack)

class ShapeSchema_PGeom_BoundedCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BoundedCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BoundedCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BoundedCurve)
};
#endif
