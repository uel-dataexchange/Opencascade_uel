...
DEFINE_STANDARD_HANDLE(ShapeSchema_ObjMgt_SeqNodeOfPSeqOfExtRef,Storage_CallBack)

class ShapeSchema_ObjMgt_SeqNodeOfPSeqOfExtRef : public Storage_CallBack {
public:
  ShapeSchema_ObjMgt_SeqNodeOfPSeqOfExtRef() {}
  Standard_EXPORT static void SAdd(const Handle(ObjMgt_SeqNodeOfPSeqOfExtRef)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_ObjMgt_SeqNodeOfPSeqOfExtRef)
};
#endif
