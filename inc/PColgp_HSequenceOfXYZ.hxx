...
inline Handle_Standard_Persistent ShallowCopy(const Handle_PColgp_HSequenceOfXYZ& me) {
 return me->ShallowCopy();
}

inline void ShallowDump(const Handle_PColgp_HSequenceOfXYZ& me,Standard_OStream& s) {
 me->ShallowDump(s);
}
