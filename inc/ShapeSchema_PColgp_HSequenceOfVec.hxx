...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HSequenceOfVec,Storage_CallBack)

class ShapeSchema_PColgp_HSequenceOfVec : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HSequenceOfVec() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HSequenceOfVec)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HSequenceOfVec)
};
#endif
