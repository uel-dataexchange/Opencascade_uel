...
DEFINE_STANDARD_HANDLE(StdSchema_PNaming_Name_1,Storage_CallBack)

class StdSchema_PNaming_Name_1 : public Storage_CallBack {
public:
  StdSchema_PNaming_Name_1() {}
  Standard_EXPORT static void SAdd(const Handle(PNaming_Name_1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PNaming_Name_1)
};
#endif
