...
//! Description of Protocol for IGESAppli <br>
...
public:
  ...
  //! Gives the count of direct Resource Protocol. Here, two <br>
//!           (Protocols from IGESDefs and IGESDraw) <br>
...
//!           consider the same Type as the Protocol defines) <br>
  ...
  DEFINE_STANDARD_RTTI(IGESAppli_Protocol)
