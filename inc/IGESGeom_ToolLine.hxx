...
#ifndef _IGESGeom_ToolLine_HeaderFile
#define _IGESGeom_ToolLine_HeaderFile
...
//! Tool to work on a Line. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_Line)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Line <ent>, from <br>
