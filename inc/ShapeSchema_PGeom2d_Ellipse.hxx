...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Ellipse,Storage_CallBack)

class ShapeSchema_PGeom2d_Ellipse : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Ellipse() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Ellipse)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Ellipse)
};
#endif
