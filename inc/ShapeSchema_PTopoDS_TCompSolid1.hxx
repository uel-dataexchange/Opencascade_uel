...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TCompSolid1,Storage_CallBack)

class ShapeSchema_PTopoDS_TCompSolid1 : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TCompSolid1() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TCompSolid1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TCompSolid1)
};
#endif
