...
public:
  ...
  Standard_EXPORT     Handle_StepGeom_Direction Axis1() const;
  ...
  Standard_EXPORT     Handle_StepGeom_Direction Axis2() const;
  ...
  Standard_EXPORT     Handle_StepGeom_CartesianPoint LocalOrigin() const;
