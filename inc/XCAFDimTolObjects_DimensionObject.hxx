...
#include <Handle_XCAFDimTolObjects_DimensionObject.hxx>
...
private: 
  ...
  NCollection_Vector1<Handle(TCollection_HAsciiString)> myDescriptions;
  NCollection_Vector1<Handle(TCollection_HAsciiString)> myDescriptionNames;
