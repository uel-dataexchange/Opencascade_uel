...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Parabola,Storage_CallBack)

class ShapeSchema_PGeom2d_Parabola : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Parabola() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Parabola)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Parabola)
};
#endif
