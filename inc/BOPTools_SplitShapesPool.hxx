...
#define _BOPTools_SplitShapesPool_HeaderFile
...
~BOPTools_SplitShapesPool()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_ListOfPaveBlock& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_ListOfPaveBlock& Value(const Standard_Integer Index) const;
   const BOPTools_ListOfPaveBlock& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_ListOfPaveBlock& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_SplitShapesPool(const BOPTools_SplitShapesPool& AnArray);
  
  Standard_EXPORT     BOPTools_SplitShapesPool& Assign(const BOPTools_SplitShapesPool& Other) ;
    BOPTools_SplitShapesPool& operator =(const BOPTools_SplitShapesPool& Other) 
{
  return Assign(Other);
}
