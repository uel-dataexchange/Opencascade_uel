...
#define _Handle_GeomInt_SequenceNodeOfSequenceOfParameterAndOrientation_HeaderFile
...
DEFINE_STANDARD_HANDLE(GeomInt_SequenceNodeOfSequenceOfParameterAndOrientation,TCollection_SeqNode)
