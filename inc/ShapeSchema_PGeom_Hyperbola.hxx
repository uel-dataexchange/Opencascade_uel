...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Hyperbola,Storage_CallBack)

class ShapeSchema_PGeom_Hyperbola : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Hyperbola() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Hyperbola)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Hyperbola)
};
#endif
