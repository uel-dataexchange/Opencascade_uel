...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray1OfDir2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray1OfDir2d,PStandard_ArrayNode)
