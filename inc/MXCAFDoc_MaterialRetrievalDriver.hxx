...
#ifndef _MXCAFDoc_MaterialRetrievalDriver_HeaderFile
#define _MXCAFDoc_MaterialRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_MaterialRetrievalDriver_HeaderFile
#include <Handle_MXCAFDoc_MaterialRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_MaterialRetrievalDriver : public MDF_ARDriver {

public:

  //! Returns mutable MaterialRetrievalDriver from MXCAFDoc; <br>
  Standard_EXPORT   MXCAFDoc_MaterialRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_Material <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_MaterialRetrievalDriver)
