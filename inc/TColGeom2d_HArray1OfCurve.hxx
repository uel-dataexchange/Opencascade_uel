...
public:
  ...
  Standard_EXPORT   TColGeom2d_HArray1OfCurve(const Standard_Integer Low,const Standard_Integer Up);
  
  Standard_EXPORT   TColGeom2d_HArray1OfCurve(const Standard_Integer Low,const Standard_Integer Up,const Handle(Geom2d_Curve)& V);
