...
DEFINE_STANDARD_HANDLE(StdLSchema_PDF_HAttributeArray1,Storage_CallBack)

class StdLSchema_PDF_HAttributeArray1 : public Storage_CallBack {
public:
  StdLSchema_PDF_HAttributeArray1() {}
  Standard_EXPORT static void SAdd(const Handle(PDF_HAttributeArray1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDF_HAttributeArray1)
};
#endif
