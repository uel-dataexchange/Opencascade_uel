...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Material,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Material : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Material() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Material)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Material)
};
#endif
