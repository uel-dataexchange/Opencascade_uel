...
#define _Handle_Extrema_SequenceNodeOfSeqPOnCOfCCLocFOfLocECCOfLocateExtCC_HeaderFile
...
DEFINE_STANDARD_HANDLE(Extrema_SequenceNodeOfSeqPOnCOfCCLocFOfLocECCOfLocateExtCC,TCollection_SeqNode)
