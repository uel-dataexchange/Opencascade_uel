...
#ifndef NCollection_Array11_HeaderFile
#define NCollection_Array11_HeaderFile
...
public:
  ...
  public:
    ...
    Iterator (const NCollection_Array11& theArray, Standard_Boolean theToEnd = Standard_False) :
    ...
    //! Initialisation
    void Init (const NCollection_Array11& theArray)
    { 
 ...
 public:
  ...
  //! Constructor
  NCollection_Array11(const Standard_Integer theLower,
                     const Standard_Integer theUpper) :
                myLowerBound                             (theLower),
                myUpperBound                             (theUpper),
                myDeletable                              (Standard_True)
  {
    Standard_RangeError_Raise_if (theUpper < theLower, "NCollection_Array11::Create");
    TheItemType* pBegin = new TheItemType[Length()];
    Standard_OutOfMemory_Raise_if (!pBegin, "NCollection_Array11 : Allocation failed");

    myData = pBegin - theLower;
  }

  //! Copy constructor 
  NCollection_Array11 (const NCollection_Array11& theOther) :
  ...
  //! Move constructor
  NCollection_Array11 (NCollection_Array11&& theOther)
  ...
  NCollection_Array11 (const TheItemType& theBegin,
    ...
    myDeletable                                 (Standard_False)
  {
    ...
    // gcc emits -Warray-bounds warning when NCollection_Array11 is initialized
    // from local array with lower index 1 (so that (&theBegin - 1) points out of array bounds).
    // NCollection_Array11 initializes myData with a shift to avoid this shift within per-element access.
  ...
  NCollection_Array11& Assign (const NCollection_Array11& theOther)
  {
    if (&theOther == this)
      return *this;

    Standard_DimensionMismatch_Raise_if (Length() != theOther.Length(), "NCollection_Array11::operator=");
    if (myData == NULL)
    {
      return *this;
    }
  ...
  NCollection_Array11& Move (NCollection_Array11& theOther)
  {
    if (&theOther == this)
    {
      return *this;
  ...
  NCollection_Array11& operator= (const NCollection_Array11& theOther)
  { 
  ...
  NCollection_Array11& operator= (NCollection_Array11&& theOther)
  {
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex < myLowerBound || theIndex > myUpperBound, "NCollection_Array11::Value");
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex < myLowerBound || theIndex > myUpperBound, "NCollection_Array11::ChangeValue");
    return myData[theIndex];
  }
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex < myLowerBound || theIndex > myUpperBound, "NCollection_Array11::SetValue");
  ...
  {
    Standard_RangeError_Raise_if (theUpper < theLower, "NCollection_Array11::Resize");
    ...
    Standard_OutOfMemory_Raise_if (aBeginNew == NULL, "NCollection_Array11 : Allocation failed");
