...
DEFINE_STANDARD_HANDLE(StdSchema_PCollection_HExtendedString,Storage_CallBack)

class StdSchema_PCollection_HExtendedString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PCollection_HExtendedString)
};
#endif
