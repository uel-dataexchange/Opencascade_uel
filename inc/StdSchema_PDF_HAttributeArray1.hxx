...
DEFINE_STANDARD_HANDLE(StdSchema_PDF_HAttributeArray1,Storage_CallBack)

class StdSchema_PDF_HAttributeArray1 : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDF_HAttributeArray1)
};
#endif
