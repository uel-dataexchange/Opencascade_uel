...
#ifndef _Graphic2d_FramedText_HeaderFile
#define _Graphic2d_FramedText_HeaderFile
...
//!         boundary limits. <br>
  ...
  DEFINE_STANDARD_RTTI(Graphic2d_FramedText)

protected:

  //! Draws the framed text <me>. <br>
  Standard_EXPORT   virtual  void Draw(const Handle(Graphic2d_Drawer)& aDrawer) ;
  //! Returns Standard_True if the framed text <me> is picked, <br>
