...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Curve,Storage_CallBack)

class ShapeSchema_PGeom_Curve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Curve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Curve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Curve)
};
#endif
