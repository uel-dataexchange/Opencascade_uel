...
#ifndef _MXCAFDoc_MaterialToolStorageDriver_HeaderFile
#define _MXCAFDoc_MaterialToolStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_MaterialToolStorageDriver_HeaderFile
#include <Handle_MXCAFDoc_MaterialToolStorageDriver.hxx>
#endif
...
class MXCAFDoc_MaterialToolStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_MaterialToolStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_MaterialToolStorageDriver)
