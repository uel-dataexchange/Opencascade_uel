...
#define _Geom2dHatch_DataMapIteratorOfMapOfElementsOfElementsOfHatcher_HeaderFile
...
public:
  ...
  Standard_EXPORT   Geom2dHatch_DataMapIteratorOfMapOfElementsOfElementsOfHatcher(const Geom2dHatch_MapOfElementsOfElementsOfHatcher& aMap);
  
  Standard_EXPORT     void Initialize(const Geom2dHatch_MapOfElementsOfElementsOfHatcher& aMap) ;
  
  Standard_EXPORT    const Standard_Integer& Key() const;
  
  Standard_EXPORT    const Geom2dHatch_ElementOfHatcher& Value() const;
