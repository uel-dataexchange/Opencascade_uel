...
#define _Handle_Expr_SequenceNodeOfSequenceOfGeneralRelation_HeaderFile
...
DEFINE_STANDARD_HANDLE(Expr_SequenceNodeOfSequenceOfGeneralRelation,TCollection_SeqNode)
