...
DEFINE_STANDARD_HANDLE(ShapeSchema_PCollection_HAsciiString,Storage_CallBack)

class ShapeSchema_PCollection_HAsciiString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PCollection_HAsciiString)
};
#endif
