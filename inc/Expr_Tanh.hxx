...
#ifndef _Expr_Tanh_HeaderFile
#define _Expr_Tanh_HeaderFile
...
public:
  ...
  //! Creates the hyperbolic tangent of <exp>. <br>
  Standard_EXPORT   Expr_Tanh(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_Tanh)
