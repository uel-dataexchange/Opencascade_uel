...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BezierSurface,Storage_CallBack)

class ShapeSchema_PGeom_BezierSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BezierSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BezierSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BezierSurface)
};
#endif
