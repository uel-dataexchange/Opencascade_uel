...
#ifndef NCollection_IndexedDataMap1_HeaderFile
#define NCollection_IndexedDataMap1_HeaderFile
...
class NCollection_IndexedDataMap : public NCollection_BaseMap1
{
public:
...
private:
  ...
  class IndexedDataMapNode : public NCollection_TListNode1<TheItemType>
  {
  public:
    ...
    IndexedDataMapNode (const TheKeyType&      theKey1, 
                        ...
                        NCollection_ListNode1*  theNext1)
    : NCollection_TListNode1<TheItemType>(theItem,theNext1),
      myKey1  (theKey1),
      myIndex (theIndex)
    { 
    }
 ...
 public:
  ...
  //! Empty constructor.
  NCollection_IndexedDataMap() : NCollection_BaseMap1 (1, Standard_False, Handle(NCollection_BaseAllocator)()) {}

  //! Constructor
  explicit NCollection_IndexedDataMap (const Standard_Integer theNbBuckets,
                                       const Handle(NCollection_BaseAllocator)& theAllocator = 0L)
  : NCollection_BaseMap1 (theNbBuckets, Standard_False, theAllocator) {}

  //! Copy constructor
  NCollection_IndexedDataMap (const NCollection_IndexedDataMap& theOther) 
    : NCollection_BaseMap1 (theOther.NbBuckets(), Standard_False, theOther.myAllocator) 
  { *this = theOther; }
  ...
  {
    NCollection_ListNode1** ppNewData1 = NULL;
    NCollection_ListNode1** ppNewData2 = NULL;
