...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BezierCurve,Storage_CallBack)

class ShapeSchema_PGeom_BezierCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BezierCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BezierCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BezierCurve)
};
#endif
