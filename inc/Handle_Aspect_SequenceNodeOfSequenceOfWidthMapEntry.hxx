...
#define _Handle_Aspect_SequenceNodeOfSequenceOfWidthMapEntry_HeaderFile
...
DEFINE_STANDARD_HANDLE(Aspect_SequenceNodeOfSequenceOfWidthMapEntry,TCollection_SeqNode)
