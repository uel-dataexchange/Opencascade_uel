...
public:
  ...
  Standard_EXPORT   StepElement_Array1OfHSequenceOfCurveElementPurposeMember(const Handle(StepElement_HSequenceOfCurveElementPurposeMember)& Item,const Standard_Integer Low,const Standard_Integer Up);
