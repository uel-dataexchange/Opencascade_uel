...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HSequenceOfDir,Storage_CallBack)

class ShapeSchema_PColgp_HSequenceOfDir : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HSequenceOfDir() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HSequenceOfDir)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HSequenceOfDir)
};
#endif
