...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_CylindricalSurface,Storage_CallBack)

class ShapeSchema_PGeom_CylindricalSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_CylindricalSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_CylindricalSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_CylindricalSurface)
};
#endif
