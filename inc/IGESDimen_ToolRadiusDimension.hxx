...
#ifndef _IGESDimen_ToolRadiusDimension_HeaderFile
#define _IGESDimen_ToolRadiusDimension_HeaderFile
...
//! Tool to work on a RadiusDimension. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESDimen_RadiusDimension)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESDimen_RadiusDimension)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a RadiusDimension <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESDimen_RadiusDimension)& ent,Interface_EntityIterator& iter) const;
  //! Returns specific DirChecker <br>
  Standard_EXPORT     IGESData_DirChecker DirChecker(const Handle(IGESDimen_RadiusDimension)& ent) const;
