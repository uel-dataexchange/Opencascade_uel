...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TCompSolid,Storage_CallBack)

class ShapeSchema_PTopoDS_TCompSolid : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TCompSolid() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TCompSolid)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TCompSolid)
};
#endif
