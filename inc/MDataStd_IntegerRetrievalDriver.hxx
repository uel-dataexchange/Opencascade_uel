...
#ifndef _MDataStd_IntegerRetrievalDriver_HeaderFile
#define _MDataStd_IntegerRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_IntegerRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_IntegerRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Integer from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_IntegerRetrievalDriver)
