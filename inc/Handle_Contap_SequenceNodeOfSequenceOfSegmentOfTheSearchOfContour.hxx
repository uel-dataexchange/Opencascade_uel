...
#define _Handle_Contap_SequenceNodeOfSequenceOfSegmentOfTheSearchOfContour_HeaderFile
...
DEFINE_STANDARD_HANDLE(Contap_SequenceNodeOfSequenceOfSegmentOfTheSearchOfContour,TCollection_SeqNode)
