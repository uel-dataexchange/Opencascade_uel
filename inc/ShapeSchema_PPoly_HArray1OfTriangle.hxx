...
DEFINE_STANDARD_HANDLE(ShapeSchema_PPoly_HArray1OfTriangle,Storage_CallBack)

class ShapeSchema_PPoly_HArray1OfTriangle : public Storage_CallBack {
public:
  ShapeSchema_PPoly_HArray1OfTriangle() {}
  Standard_EXPORT static void SAdd(const Handle(PPoly_HArray1OfTriangle)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PPoly_HArray1OfTriangle)
};
#endif
