...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Area,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Area : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Area() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Area)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Area)
};
#endif
