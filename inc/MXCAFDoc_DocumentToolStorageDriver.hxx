...
#ifndef _MXCAFDoc_DocumentToolStorageDriver_HeaderFile
#define _MXCAFDoc_DocumentToolStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_DocumentToolStorageDriver_HeaderFile
#include <Handle_MXCAFDoc_DocumentToolStorageDriver.hxx>
#endif
...
class MXCAFDoc_DocumentToolStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_DocumentToolStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_DocumentToolStorageDriver)
