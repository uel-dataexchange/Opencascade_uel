...
#ifndef _MDataStd_IntPackedMapStorageDriver_HeaderFile
#define _MDataStd_IntPackedMapStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_IntPackedMapStorageDriver_HeaderFile
...
//! Storage driver for IntPackedMap attribute <br>
class MDataStd_IntPackedMapStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MDataStd_IntPackedMapStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_IntPackedMapStorageDriver)
