...
#ifndef NCollection_BaseVector1_HeaderFile
#define NCollection_BaseVector1_HeaderFile

#include <Standard_TypeDef.hxx>
#include <Standard_OutOfRange.hxx>
#include <Standard_DefineAlloc.hxx>
#include <NCollection_BaseAllocator1.hxx>
...
inline Standard_Integer GetCapacity1 (const Standard_Integer theIncrement)
{
  return Max(theIncrement/8, 1);
}

//! Class NCollection_BaseVector1 - base for NCollection_Vector template
class NCollection_BaseVector1
{
public:
  //! Memory allocation
...
protected:
  ...
  protected:
    ...
    Iterator (const NCollection_BaseVector1& theVector, Standard_Boolean theToEnd = Standard_False)
    {
    ...
    Standard_EXPORT void initV (const NCollection_BaseVector1& theVector, Standard_Boolean theToEnd = Standard_False);
    ...
    const NCollection_BaseVector1* myVector;    //!< the Master vector
...
protected: //! @name Block initializer
  ...
  typedef void (*initMemBlocks_t) (NCollection_BaseVector1& theVector,
                                   MemBlock&               theBlock,
...
protected: //! @name protected methods
  ...
  //! Empty constructor
  NCollection_BaseVector1 (const Handle(NCollection_BaseAllocator)& theAllocator,
  ...
  : myItemSize   (theSize),
    myIncrement  (theInc),
    myLength     (0),
    myCapacity   (GetCapacity1 (myIncrement)),
    myNBlocks    (0),
  ...
  NCollection_BaseVector1 (const Handle(NCollection_BaseAllocator)& theAllocator,
                          initMemBlocks_t                    theInitBlocks,
                          const NCollection_BaseVector1&      theOther)
  : myItemSize   (theOther.myItemSize),
    myIncrement  (theOther.myIncrement),
    myLength     (theOther.myLength),
    myCapacity   (GetCapacity1(myIncrement) + theOther.myLength / theOther.myIncrement),
  ...
  //! Destructor
  virtual ~NCollection_BaseVector1() {}
