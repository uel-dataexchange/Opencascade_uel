...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Surface,Storage_CallBack)

class ShapeSchema_PGeom_Surface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Surface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Surface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Surface)
};
#endif
