...
#ifndef _IGESDimen_ToolLeaderArrow_HeaderFile
#define _IGESDimen_ToolLeaderArrow_HeaderFile
...
//! Tool to work on a LeaderArrow. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESDimen_LeaderArrow)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a LeaderArrow <ent>, from <br>
