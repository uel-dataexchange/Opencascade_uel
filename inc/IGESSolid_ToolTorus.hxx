...
#ifndef _IGESSolid_ToolTorus_HeaderFile
#define _IGESSolid_ToolTorus_HeaderFile
...
//! Tool to work on a Torus. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_Torus)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Torus <ent>, from <br>
