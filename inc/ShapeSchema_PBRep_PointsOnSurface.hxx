...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PointsOnSurface,Storage_CallBack)

class ShapeSchema_PBRep_PointsOnSurface : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PointsOnSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PointsOnSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PointsOnSurface)
};
#endif
