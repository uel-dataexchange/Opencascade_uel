...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Comment,Storage_CallBack)

class StdLSchema_PDataStd_Comment : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Comment() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Comment)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Comment)
};
#endif
