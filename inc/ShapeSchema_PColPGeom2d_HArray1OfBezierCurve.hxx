...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom2d_HArray1OfBezierCurve,Storage_CallBack)

class ShapeSchema_PColPGeom2d_HArray1OfBezierCurve : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom2d_HArray1OfBezierCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom2d_HArray1OfBezierCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom2d_HArray1OfBezierCurve)
};
#endif
