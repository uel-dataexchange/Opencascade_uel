...
#endif
#ifndef _Handle_PDataStd_Name_HeaderFile
...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Name,Storage_CallBack)

class StdLSchema_PDataStd_Name : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Name() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Name)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Name)
};
#endif
