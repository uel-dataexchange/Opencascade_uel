...
#ifndef _MXCAFDoc_AreaStorageDriver_HeaderFile
#define _MXCAFDoc_AreaStorageDriver_HeaderFile
...
#include <Handle_MXCAFDoc_AreaStorageDriver.hxx>
#endif
...
class MXCAFDoc_AreaStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_AreaStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_Area. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_AreaStorageDriver)
