...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_BooleanArray,Storage_CallBack)

class StdLSchema_PDataStd_BooleanArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_BooleanArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_BooleanArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_BooleanArray)
};
#endif
