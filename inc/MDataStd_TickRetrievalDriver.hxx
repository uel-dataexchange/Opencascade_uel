...
#ifndef _MDataStd_TickRetrievalDriver_HeaderFile
#define _MDataStd_TickRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_TickRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_TickRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type Tick from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_TickRetrievalDriver)
