...
#ifndef _MDataStd_CommentStorageDriver_HeaderFile
#define _MDataStd_CommentStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_CommentStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_CommentStorageDriver)
