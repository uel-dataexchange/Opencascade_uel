...
DEFINE_STANDARD_HANDLE(ShapeSchema_PCollection_HExtendedString,Storage_CallBack)

class ShapeSchema_PCollection_HExtendedString : public Storage_CallBack {
public:
  ShapeSchema_PCollection_HExtendedString() {}
  Standard_EXPORT static void SAdd(const Handle(PCollection_HExtendedString)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PCollection_HExtendedString)
};
#endif
