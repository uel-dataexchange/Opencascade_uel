...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_IntegerArray,Storage_CallBack)

class StdLSchema_PDataStd_IntegerArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_IntegerArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_IntegerArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_IntegerArray)
};
#endif
