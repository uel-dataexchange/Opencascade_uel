...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray1OfXY,Storage_CallBack)

class ShapeSchema_PColgp_HArray1OfXY : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray1OfXY() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray1OfXY)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray1OfXY)
};
#endif
