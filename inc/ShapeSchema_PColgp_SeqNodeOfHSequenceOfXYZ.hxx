...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_SeqNodeOfHSequenceOfXYZ,Storage_CallBack)

class ShapeSchema_PColgp_SeqNodeOfHSequenceOfXYZ : public Storage_CallBack {
public:
  ShapeSchema_PColgp_SeqNodeOfHSequenceOfXYZ() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_SeqNodeOfHSequenceOfXYZ)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_SeqNodeOfHSequenceOfXYZ)
};
#endif
