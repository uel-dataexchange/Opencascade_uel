...
#ifndef _MXCAFDoc_VolumeStorageDriver_HeaderFile
#define _MXCAFDoc_VolumeStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_VolumeStorageDriver_HeaderFile
#include <Handle_MXCAFDoc_VolumeStorageDriver.hxx>
#endif
...
class MXCAFDoc_VolumeStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_VolumeStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_Volume. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_VolumeStorageDriver)
