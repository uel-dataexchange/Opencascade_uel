...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_Face,Storage_CallBack)

class ShapeSchema_PTopoDS_Face : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_Face() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_Face)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_Face)
};
#endif
