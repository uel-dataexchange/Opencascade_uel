...
#ifndef _Expr_Sinh_HeaderFile
#define _Expr_Sinh_HeaderFile
...
#endif
#ifndef _Handle_Expr_Sinh_HeaderFile
...
public:
  ...
  //! Creates the sinh of <exp>. <br>
  Standard_EXPORT   Expr_Sinh(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_Sinh)
