...
#define _Handle_SelectBasics_SequenceNodeOfSequenceOfOwner_HeaderFile
...
DEFINE_STANDARD_HANDLE(SelectBasics_SequenceNodeOfSequenceOfOwner,TCollection_SeqNode)
