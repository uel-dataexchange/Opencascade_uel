...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TWire1,Storage_CallBack)

class ShapeSchema_PTopoDS_TWire1 : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TWire1() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TWire1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TWire1)
};
#endif
