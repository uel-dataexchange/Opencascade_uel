...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_Curve3D,Storage_CallBack)

class ShapeSchema_PBRep_Curve3D : public Storage_CallBack {
public:
  ShapeSchema_PBRep_Curve3D() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_Curve3D)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_Curve3D)
};
#endif
