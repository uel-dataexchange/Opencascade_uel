...
DEFINE_STANDARD_HANDLE(XCAFSchema_PCollection_HAsciiString,Storage_CallBack)

class XCAFSchema_PCollection_HAsciiString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PCollection_HAsciiString)
};
#endif
