...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColStd_HArray1OfInteger,Storage_CallBack)

class ShapeSchema_PColStd_HArray1OfInteger : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColStd_HArray1OfInteger)
};
#endif
