...
//! Definition of General Services for IGESSolid (specific part) <br>
//!           This Services comprise : Shared & Implied Lists, Copy, Check <br>
class IGESSolid_GeneralModule : public IGESData_GeneralModule {

public:

  //! Creates a GeneralModule from IGESSolid and puts it into GeneralLib <br>
...
//!           Shape for all <br>
  ...
  DEFINE_STANDARD_RTTI(IGESSolid_GeneralModule)
