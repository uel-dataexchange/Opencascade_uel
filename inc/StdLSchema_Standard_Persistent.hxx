...
DEFINE_STANDARD_HANDLE(StdLSchema_Standard_Persistent,Storage_CallBack)

class StdLSchema_Standard_Persistent : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_Standard_Persistent)
};
#endif
