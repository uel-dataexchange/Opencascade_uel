...
#ifndef _IGESDimen_ToolLinearDimension_HeaderFile
#define _IGESDimen_ToolLinearDimension_HeaderFile
...
//! Tool to work on a LinearDimension. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESDimen_LinearDimension)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESDimen_LinearDimension)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a LinearDimension <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESDimen_LinearDimension)& ent,Interface_EntityIterator& iter) const;
