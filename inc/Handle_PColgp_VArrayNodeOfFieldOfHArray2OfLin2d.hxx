...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray2OfLin2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray2OfLin2d,PStandard_ArrayNode)
