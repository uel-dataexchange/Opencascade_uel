...
#ifndef _MXCAFDoc_DocumentToolRetrievalDriver_HeaderFile
#define _MXCAFDoc_DocumentToolRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_DocumentToolRetrievalDriver_HeaderFile
#include <Handle_MXCAFDoc_DocumentToolRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_DocumentToolRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_DocumentToolRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_DocumentToolRetrievalDriver)
