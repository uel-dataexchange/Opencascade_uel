...
DEFINE_STANDARD_HANDLE(ShapeSchema_ObjMgt_ExternRef,Storage_CallBack)

class ShapeSchema_ObjMgt_ExternRef : public Storage_CallBack {
public:
  ShapeSchema_ObjMgt_ExternRef() {}
  Standard_EXPORT static void SAdd(const Handle(ObjMgt_ExternRef)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_ObjMgt_ExternRef)
};
#endif
