...
#ifndef _Expr_Tangent_HeaderFile
#define _Expr_Tangent_HeaderFile
...
#endif
#ifndef _Handle_Expr_Tangent_HeaderFile
...
public:
  ...
  //! Creates the tangent of <exp>. <br>
  Standard_EXPORT   Expr_Tangent(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_Tangent)
