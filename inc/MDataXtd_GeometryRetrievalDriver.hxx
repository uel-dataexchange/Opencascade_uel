...
#ifndef _MDataXtd_GeometryRetrievalDriver_HeaderFile
#define _MDataXtd_GeometryRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataXtd_GeometryRetrievalDriver_HeaderFile
#include <Handle_MDataXtd_GeometryRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_GeometryRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Geometry from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_GeometryRetrievalDriver)
