...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Direction,Storage_CallBack)

class ShapeSchema_PGeom_Direction : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Direction() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Direction)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Direction)
};
#endif
