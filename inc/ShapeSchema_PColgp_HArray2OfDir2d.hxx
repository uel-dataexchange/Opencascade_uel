...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray2OfDir2d,Storage_CallBack)

class ShapeSchema_PColgp_HArray2OfDir2d : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray2OfDir2d() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray2OfDir2d)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray2OfDir2d)
};
#endif
