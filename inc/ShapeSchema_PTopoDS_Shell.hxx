...
#endif
#ifndef _Handle_PTopoDS_Shell_HeaderFile
...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_Shell,Storage_CallBack)

class ShapeSchema_PTopoDS_Shell : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_Shell() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_Shell)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_Shell)
};
#endif
