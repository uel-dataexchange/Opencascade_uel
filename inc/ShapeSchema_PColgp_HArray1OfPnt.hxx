...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray1OfPnt,Storage_CallBack)

class ShapeSchema_PColgp_HArray1OfPnt : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray1OfPnt() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray1OfPnt)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray1OfPnt)
};
#endif
