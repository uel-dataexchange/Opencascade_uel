...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TWire,Storage_CallBack)

class ShapeSchema_PTopoDS_TWire : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TWire() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TWire)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TWire)
};
#endif
