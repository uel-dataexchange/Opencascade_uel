...
DEFINE_STANDARD_HANDLE(StdLSchema_PDocStd_XLink,Storage_CallBack)

class StdLSchema_PDocStd_XLink : public Storage_CallBack {
public:
  StdLSchema_PDocStd_XLink() {}
  Standard_EXPORT static void SAdd(const Handle(PDocStd_XLink)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDocStd_XLink)
};
#endif
