...
#define _Handle_TColStd_SequenceNodeOfSequenceOfExtendedString_HeaderFile
...
DEFINE_STANDARD_HANDLE(TColStd_SequenceNodeOfSequenceOfExtendedString,TCollection_SeqNode)
