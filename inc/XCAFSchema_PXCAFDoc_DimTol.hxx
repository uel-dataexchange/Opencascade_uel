...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_DimTol,Storage_CallBack)

class XCAFSchema_PXCAFDoc_DimTol : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_DimTol() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_DimTol)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_DimTol)
};
#endif
