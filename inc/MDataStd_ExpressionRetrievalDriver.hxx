...
#ifndef _MDataStd_ExpressionRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_ExpressionRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_ExpressionRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Expression from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_ExpressionRetrievalDriver)
