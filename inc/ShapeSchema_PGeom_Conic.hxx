...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Conic,Storage_CallBack)

class ShapeSchema_PGeom_Conic : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Conic() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Conic)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Conic)
};
#endif
