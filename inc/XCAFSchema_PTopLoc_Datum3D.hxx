...
DEFINE_STANDARD_HANDLE(XCAFSchema_PTopLoc_Datum3D,Storage_CallBack)

class XCAFSchema_PTopLoc_Datum3D : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PTopLoc_Datum3D)
};
#endif
