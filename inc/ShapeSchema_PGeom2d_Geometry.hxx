...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Geometry,Storage_CallBack)

class ShapeSchema_PGeom2d_Geometry : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Geometry() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Geometry)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Geometry)
};
#endif
