...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_HArray1OfHArray1OfInteger,Storage_CallBack)

class StdLSchema_PDataStd_HArray1OfHArray1OfInteger : public Storage_CallBack {
public:
  StdLSchema_PDataStd_HArray1OfHArray1OfInteger() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_HArray1OfHArray1OfInteger)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_HArray1OfHArray1OfInteger)
};
#endif
