...
#ifndef _MDataStd_ExtStringArrayRetrievalDriver_1_HeaderFile
#define _MDataStd_ExtStringArrayRetrievalDriver_1_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_ExtStringArrayRetrievalDriver_1_HeaderFile
...
//! Retrieval  driver of ExtStringArray attribute supporting <br>
...
public:
  ...
  Standard_EXPORT   MDataStd_ExtStringArrayRetrievalDriver_1(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 1. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: ExtStringArray from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_ExtStringArrayRetrievalDriver_1)
