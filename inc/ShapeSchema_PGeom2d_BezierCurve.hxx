...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_BezierCurve,Storage_CallBack)

class ShapeSchema_PGeom2d_BezierCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_BezierCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_BezierCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_BezierCurve)
};
#endif
