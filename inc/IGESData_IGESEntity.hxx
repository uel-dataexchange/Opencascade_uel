...
//!           Associativity Entity if there is one. Returns a null handle if there is none. <br>
  ...
  Standard_EXPORT     void LineWeightNumber(Standard_Integer weightNum);
...
//!           or sets it to defw (Default) if LineWeightNumber is null <br>
  ...
  Standard_EXPORT	 void SetDirNumber(Standard_Integer &dirNum);
  Standard_EXPORT Standard_Integer DirNumber();
