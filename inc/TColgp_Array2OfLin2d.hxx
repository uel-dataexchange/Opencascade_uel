...
#define _TColgp_Array2OfLin2d_HeaderFile
...
public:
  ...
  Standard_EXPORT   TColgp_Array2OfLin2d(const gp_Lin2d& Item,const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2);
...
~TColgp_Array2OfLin2d()
{
  ...
  Standard_EXPORT    const TColgp_Array2OfLin2d& Assign(const TColgp_Array2OfLin2d& Other) ;
...
private:
  ...
  Standard_EXPORT   TColgp_Array2OfLin2d(const TColgp_Array2OfLin2d& AnArray);
