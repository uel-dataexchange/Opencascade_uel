...
#define _PColPGeom2d_FieldOfHArray1OfBoundedCurve_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColPGeom2d_FieldOfHArray1OfBoundedCurve);
...
public:
  ...
  Standard_EXPORT   PColPGeom2d_FieldOfHArray1OfBoundedCurve(const Standard_Integer Size);
  
  Standard_EXPORT   PColPGeom2d_FieldOfHArray1OfBoundedCurve(const PColPGeom2d_FieldOfHArray1OfBoundedCurve& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColPGeom2d_FieldOfHArray1OfBoundedCurve& Other) ;
