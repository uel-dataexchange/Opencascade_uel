...
#ifndef _IGESSolid_ToolSolidInstance_HeaderFile
#define _IGESSolid_ToolSolidInstance_HeaderFile
...
//! Tool to work on a SolidInstance. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_SolidInstance)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a SolidInstance <ent>, from <br>
