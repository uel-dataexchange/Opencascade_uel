...
#define _BOP_IndexedDataMapOfSolidClassifier_HeaderFile
...
public:
  ...
  Standard_EXPORT     BOP_IndexedDataMapOfSolidClassifier& Assign(const BOP_IndexedDataMapOfSolidClassifier& Other) ;
...
~BOP_IndexedDataMapOfSolidClassifier()
{
  ...
  Standard_EXPORT     Standard_Integer Add(const TopoDS_Shape& K,const BOP_PSoClassif& I) ;
  
  Standard_EXPORT     void Substitute(const Standard_Integer I,const TopoDS_Shape& K,const BOP_PSoClassif& T) ;
  ...
  Standard_EXPORT    const BOP_PSoClassif& FindFromIndex(const Standard_Integer I) const;
   const BOP_PSoClassif& operator ()(const Standard_Integer I) const
{
  return FindFromIndex(I);
}
  
  Standard_EXPORT     BOP_PSoClassif& ChangeFromIndex(const Standard_Integer I) ;
...
private:
  ...
  Standard_EXPORT   BOP_IndexedDataMapOfSolidClassifier(const BOP_IndexedDataMapOfSolidClassifier& Other);
