...
#endif
#ifndef _Handle_IGESBasic_SpecificModule_HeaderFile
...
//!           Dump & OwnCorrect, for IGESBasic <br>
class IGESBasic_SpecificModule : public IGESData_SpecificModule {

public:

  //! Creates a SpecificModule from IGESBasic & puts it into SpecificLib <br>
  Standard_EXPORT   IGESBasic_SpecificModule();
  //! Specific Dump (own parameters) for IGESBasic <br>
...
//!           them (AssocGroupType,Hierarchy,Name,SingleParent) <br>
