...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom_HArray1OfSurface,Storage_CallBack)

class ShapeSchema_PColPGeom_HArray1OfSurface : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom_HArray1OfSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom_HArray1OfSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom_HArray1OfSurface)
};
#endif
