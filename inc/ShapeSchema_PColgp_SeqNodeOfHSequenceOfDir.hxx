...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_SeqNodeOfHSequenceOfDir,Storage_CallBack)

class ShapeSchema_PColgp_SeqNodeOfHSequenceOfDir : public Storage_CallBack {
public:
  ShapeSchema_PColgp_SeqNodeOfHSequenceOfDir() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_SeqNodeOfHSequenceOfDir)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_SeqNodeOfHSequenceOfDir)
};
#endif
