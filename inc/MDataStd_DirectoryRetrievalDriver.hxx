...
#ifndef _MDataStd_DirectoryRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_DirectoryRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_DirectoryRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Directory from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_DirectoryRetrievalDriver)
