...
#define _TColGeom_Array2OfSurface_HeaderFile
...
public:
  ...
  Standard_EXPORT   TColGeom_Array2OfSurface(const Handle(Geom_Surface)& Item,const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2);
...
~TColGeom_Array2OfSurface()
{
  ...
  Standard_EXPORT    const TColGeom_Array2OfSurface& Assign(const TColGeom_Array2OfSurface& Other) ;
...
private:
  ...
  Standard_EXPORT   TColGeom_Array2OfSurface(const TColGeom_Array2OfSurface& AnArray);
