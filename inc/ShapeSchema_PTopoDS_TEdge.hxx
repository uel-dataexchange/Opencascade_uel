...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TEdge,Storage_CallBack)

class ShapeSchema_PTopoDS_TEdge : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TEdge() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TEdge)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TEdge)
};
#endif
