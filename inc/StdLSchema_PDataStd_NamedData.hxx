...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_NamedData,Storage_CallBack)

class StdLSchema_PDataStd_NamedData : public Storage_CallBack {
public:
  StdLSchema_PDataStd_NamedData() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_NamedData)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_NamedData)
};
#endif
