...
#define _Handle_Expr_SequenceNodeOfSequenceOfGeneralExpression_HeaderFile
...
DEFINE_STANDARD_HANDLE(Expr_SequenceNodeOfSequenceOfGeneralExpression,TCollection_SeqNode)
