...
#ifndef _MXCAFDoc_DimTolStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_DimTolStorageDriver_HeaderFile
#include <Handle_MXCAFDoc_DimTolStorageDriver.hxx>
#endif
...
class MXCAFDoc_DimTolStorageDriver : public MDF_ASDriver {

public:

  //! Returns mutable DimTolStorageDriver from MXCAFDoc; <br>
  Standard_EXPORT   MXCAFDoc_DimTolStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_DimTol. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_DimTolStorageDriver)
