...
DEFINE_STANDARD_HANDLE(StdSchema_PNaming_Naming,Storage_CallBack)

class StdSchema_PNaming_Naming : public Storage_CallBack {
public:
  StdSchema_PNaming_Naming() {}
  Standard_EXPORT static void SAdd(const Handle(PNaming_Naming)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PNaming_Naming)
};
#endif
