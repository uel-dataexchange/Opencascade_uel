...
#ifndef _MNaming_NamingRetrievalDriver_1_HeaderFile
#define _MNaming_NamingRetrievalDriver_1_HeaderFile
...
#endif
#ifndef _Handle_MNaming_NamingRetrievalDriver_1_HeaderFile
...
public:
  ...
  Standard_EXPORT   MNaming_NamingRetrievalDriver_1(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Naming from PNaming. <br>
  ...
  DEFINE_STANDARD_RTTI(MNaming_NamingRetrievalDriver_1)
