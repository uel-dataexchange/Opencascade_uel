...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TShape,Storage_CallBack)

class ShapeSchema_PTopoDS_TShape : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TShape() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TShape)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TShape)
};
#endif
