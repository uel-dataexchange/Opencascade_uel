...
#define _Handle_TransferBRep_SequenceNodeOfSequenceOfTransferResultInfo_HeaderFile
...
DEFINE_STANDARD_HANDLE(TransferBRep_SequenceNodeOfSequenceOfTransferResultInfo,TCollection_SeqNode)
