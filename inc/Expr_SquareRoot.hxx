...
#endif
#ifndef _Handle_Expr_SquareRoot_HeaderFile
...
public:
  ...
  //! Creates the square root of <exp> <br>
  Standard_EXPORT   Expr_SquareRoot(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_SquareRoot)
