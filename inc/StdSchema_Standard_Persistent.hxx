...
DEFINE_STANDARD_HANDLE(StdSchema_Standard_Persistent,Storage_CallBack)

class StdSchema_Standard_Persistent : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_Standard_Persistent)
};
#endif
