...
#define _Handle_TColStd_SequenceNodeOfSequenceOfAsciiString_HeaderFile
...
DEFINE_STANDARD_HANDLE(TColStd_SequenceNodeOfSequenceOfAsciiString,TCollection_SeqNode)
