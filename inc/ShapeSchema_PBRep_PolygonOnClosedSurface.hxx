...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PolygonOnClosedSurface,Storage_CallBack)

class ShapeSchema_PBRep_PolygonOnClosedSurface : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PolygonOnClosedSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PolygonOnClosedSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PolygonOnClosedSurface)
};
#endif
