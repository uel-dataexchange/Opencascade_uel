...
DEFINE_STANDARD_HANDLE(StdSchema_PDF_Attribute,Storage_CallBack)

class StdSchema_PDF_Attribute : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDF_Attribute)
};
#endif
