...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Vector,Storage_CallBack)

class ShapeSchema_PGeom_Vector : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Vector() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Vector)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Vector)
};
#endif
