...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_AxisPlacement,Storage_CallBack)

class ShapeSchema_PGeom2d_AxisPlacement : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_AxisPlacement() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_AxisPlacement)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_AxisPlacement)
};
#endif
