...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopLoc_ItemLocation,Storage_CallBack)

class ShapeSchema_PTopLoc_ItemLocation : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopLoc_ItemLocation)
};
#endif
