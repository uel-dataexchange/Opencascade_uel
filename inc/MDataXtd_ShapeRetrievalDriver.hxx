...
#ifndef _MDataXtd_ShapeRetrievalDriver_HeaderFile
...
#include <Handle_MDataXtd_ShapeRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_ShapeRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Shape from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_ShapeRetrievalDriver)
