...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Transformation,Storage_CallBack)

class ShapeSchema_PGeom_Transformation : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Transformation() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Transformation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Transformation)
};
#endif
