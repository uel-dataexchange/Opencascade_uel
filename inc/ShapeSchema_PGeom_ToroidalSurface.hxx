...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_ToroidalSurface,Storage_CallBack)

class ShapeSchema_PGeom_ToroidalSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_ToroidalSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_ToroidalSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_ToroidalSurface)
};
#endif
