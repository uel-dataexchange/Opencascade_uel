...
#endif
#ifndef _Handle_IGESBasic_ReadWriteModule_HeaderFile
...
//! Defines basic File Access Module for IGESBasic (specific parts) <br>
...
public:
  ...
  //! Defines Case Numbers for Entities of IGESBasic <br>
  Standard_EXPORT     Standard_Integer CaseIGES(const Standard_Integer typenum,const Standard_Integer formnum) const;
  //! Reads own parameters from file for an Entity of IGESBasic <br>
