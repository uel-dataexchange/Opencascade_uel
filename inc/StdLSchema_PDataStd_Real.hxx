...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Real,Storage_CallBack)

class StdLSchema_PDataStd_Real : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Real)
};
#endif
