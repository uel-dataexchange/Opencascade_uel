...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_GraphNode,Storage_CallBack)

class XCAFSchema_PXCAFDoc_GraphNode : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_GraphNode() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_GraphNode)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_GraphNode)
};
#endif
