...
#ifndef _MDataStd_UAttributeRetrievalDriver_HeaderFile
#define _MDataStd_UAttributeRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_UAttributeRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_UAttributeRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: UAttribute from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_UAttributeRetrievalDriver)
