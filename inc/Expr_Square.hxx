...
#ifndef _Expr_Square_HeaderFile
#define _Expr_Square_HeaderFile
...
#endif
#ifndef _Handle_Expr_Square_HeaderFile
...
public:
  ...
  //! Creates the square of <exp>. <br>
  Standard_EXPORT   Expr_Square(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_Square)
