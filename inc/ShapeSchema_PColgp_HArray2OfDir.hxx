...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray2OfDir,Storage_CallBack)

class ShapeSchema_PColgp_HArray2OfDir : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray2OfDir() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray2OfDir)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray2OfDir)
};
#endif
