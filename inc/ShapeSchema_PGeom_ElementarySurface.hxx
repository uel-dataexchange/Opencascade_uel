...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_ElementarySurface,Storage_CallBack)

class ShapeSchema_PGeom_ElementarySurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_ElementarySurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_ElementarySurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_ElementarySurface)
};
#endif
