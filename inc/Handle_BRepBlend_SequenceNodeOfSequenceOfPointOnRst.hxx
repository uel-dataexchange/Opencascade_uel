...
#define _Handle_BRepBlend_SequenceNodeOfSequenceOfPointOnRst_HeaderFile
...
DEFINE_STANDARD_HANDLE(BRepBlend_SequenceNodeOfSequenceOfPointOnRst,TCollection_SeqNode)
