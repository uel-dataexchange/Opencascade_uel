...
#ifndef _IGESSolid_ToolSelectedComponent_HeaderFile
#define _IGESSolid_ToolSelectedComponent_HeaderFile
...
//! Tool to work on a SelectedComponent. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_SelectedComponent)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a SelectedComponent <ent>, from <br>
