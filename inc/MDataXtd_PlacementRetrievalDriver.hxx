...
#ifndef _MDataXtd_PlacementRetrievalDriver_HeaderFile
#define _MDataXtd_PlacementRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataXtd_PlacementRetrievalDriver_HeaderFile
#include <Handle_MDataXtd_PlacementRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_PlacementRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Placement from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_PlacementRetrievalDriver)
