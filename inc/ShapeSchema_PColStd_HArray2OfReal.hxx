...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColStd_HArray2OfReal,Storage_CallBack)

class ShapeSchema_PColStd_HArray2OfReal : public Storage_CallBack {
public:
  ShapeSchema_PColStd_HArray2OfReal() {}
  Standard_EXPORT static void SAdd(const Handle(PColStd_HArray2OfReal)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColStd_HArray2OfReal)
};
#endif
