...
#ifndef _MDataStd_RelationRetrievalDriver_HeaderFile
#define _MDataStd_RelationRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_RelationRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_RelationRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Relation from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_RelationRetrievalDriver)
