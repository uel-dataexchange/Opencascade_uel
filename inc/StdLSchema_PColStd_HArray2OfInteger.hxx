...
DEFINE_STANDARD_HANDLE(StdLSchema_PColStd_HArray2OfInteger,Storage_CallBack)

class StdLSchema_PColStd_HArray2OfInteger : public Storage_CallBack {
public:
  StdLSchema_PColStd_HArray2OfInteger() {}
  Standard_EXPORT static void SAdd(const Handle(PColStd_HArray2OfInteger)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PColStd_HArray2OfInteger)
};
#endif
