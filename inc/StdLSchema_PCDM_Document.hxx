...
DEFINE_STANDARD_HANDLE(StdLSchema_PCDM_Document,Storage_CallBack)

class StdLSchema_PCDM_Document : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PCDM_Document)
};
#endif
