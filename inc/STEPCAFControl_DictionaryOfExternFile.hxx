...
public:
  ...
  Standard_EXPORT    const Handle_STEPCAFControl_ExternFile& Item(const Standard_CString name,const Standard_Boolean exact = Standard_True) const;
  
  Standard_EXPORT    const Handle_STEPCAFControl_ExternFile& Item(const TCollection_AsciiString& name,const Standard_Boolean exact = Standard_True) const;
  ...
  Standard_EXPORT     Handle_STEPCAFControl_ExternFile& NewItem(const Standard_CString name,Standard_Boolean& isvalued,const Standard_Boolean exact = Standard_True) ;
  
  Standard_EXPORT     Handle_STEPCAFControl_ExternFile& NewItem(const TCollection_AsciiString& name,Standard_Boolean& isvalued,const Standard_Boolean exact = Standard_True) ;
  ...
  Standard_EXPORT     Handle_STEPCAFControl_DictionaryOfExternFile Copy() const;
...
private: 
  ...
  Standard_EXPORT     Handle_STEPCAFControl_DictionaryOfExternFile Sub() const;
  
  Standard_EXPORT     Standard_Boolean HasNext() const;
  
  Standard_EXPORT     Handle_STEPCAFControl_DictionaryOfExternFile Next() const;
  ...
  Standard_EXPORT    const Handle_STEPCAFControl_ExternFile& It() const;
  
  Standard_EXPORT     Handle_STEPCAFControl_ExternFile& ItAdr() ;
...
Handle_STEPCAFControl_DictionaryOfExternFile thesub;
Handle_STEPCAFControl_DictionaryOfExternFile thenext;
Handle_STEPCAFControl_ExternFile theitem;
