...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_TEdge,Storage_CallBack)

class ShapeSchema_PBRep_TEdge : public Storage_CallBack {
public:
  ShapeSchema_PBRep_TEdge() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_TEdge)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_TEdge)
};
#endif
