...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_AxisPlacement,Storage_CallBack)

class ShapeSchema_PGeom_AxisPlacement : public Storage_CallBack {
public:
  ShapeSchema_PGeom_AxisPlacement() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_AxisPlacement)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_AxisPlacement)
};
#endif
