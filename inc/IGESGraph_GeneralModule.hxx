...
#endif
#ifndef _Handle_IGESGraph_GeneralModule_HeaderFile
...
//! Definition of General Services for IGESGraph (specific part) <br>
//!           This Services comprise : Shared & Implied Lists, Copy, Check <br>
class IGESGraph_GeneralModule : public IGESData_GeneralModule {

public:

  //! Creates a GeneralModule from IGESGraph and puts it into GeneralLib <br>
...
//!           Drawing for all <br>
  ...
  DEFINE_STANDARD_RTTI(IGESGraph_GeneralModule)
