...
#ifndef _IGESSolid_ToolCylinder_HeaderFile
#define _IGESSolid_ToolCylinder_HeaderFile
...
//! Tool to work on a Cylinder. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_Cylinder)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Cylinder <ent>, from <br>
