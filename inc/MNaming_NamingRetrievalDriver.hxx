...
#ifndef _MNaming_NamingRetrievalDriver_HeaderFile
#define _MNaming_NamingRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MNaming_NamingRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MNaming_NamingRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Constraint from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MNaming_NamingRetrievalDriver)
