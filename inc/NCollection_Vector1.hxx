...
#ifndef NCollection_Vector1_HeaderFile
#define NCollection_Vector1_HeaderFile

#include <NCollection_BaseVector1.hxx>
#include <NCollection_StlIterator.hxx>

//! Class NCollection_Vector1 (dynamic array of objects)
//!
...
class NCollection_Vector1 : public NCollection_BaseVector1
{
public:
...
public:
  ...
  class Iterator : public NCollection_BaseVector1::Iterator
  {
  public:
    ...
    Iterator (const NCollection_Vector1& theVector, Standard_Boolean theToEnd = Standard_False)
    : NCollection_BaseVector1::Iterator (theVector, theToEnd) {}

    //! Copy constructor
    Iterator (const Iterator& theOther)
    : NCollection_BaseVector1::Iterator (theOther) {}

    //! Initialisation
    void Init (const NCollection_Vector1& theVector)
    {
      initV (theVector);
    }
...
public: //! @name public methods
  ...
  //! Constructor
  explicit NCollection_Vector1 (const Standard_Integer theIncrement              = 256,
                               const Handle(NCollection_BaseAllocator)& theAlloc = NULL) :
    NCollection_BaseVector1 (theAlloc, initMemBlocks, sizeof(TheItemType), theIncrement)
  {}

  //! Copy constructor
  NCollection_Vector1 (const NCollection_Vector1& theOther) :
	  NCollection_BaseVector1(theOther.myAllocator, initMemBlocks, theOther)
  {
    copyData (theOther);
  }

  //! Destructor
  virtual ~NCollection_Vector1()
  {
  ...
  inline void Assign (const NCollection_Vector1& theOther,
                      const Standard_Boolean theOwnAllocator = Standard_True);

  //! Assignment operator
  NCollection_Vector1& operator= (const NCollection_Vector1& theOther)
  {
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex < 0, "NCollection_Vector1::SetValue");
...
private: //! @name private methods
  ...
  void copyData (const NCollection_Vector1& theOther)
  {
    Standard_Integer iBlock = 0;
    /*NCollection_Vector1::*/Iterator anIter (theOther);
  ...
  static void initMemBlocks (NCollection_BaseVector1&           theVector,
                             NCollection_BaseVector1::MemBlock& theBlock,
                             const Standard_Integer            theFirst,
                             const Standard_Integer            theSize)
  {
    NCollection_Vector1& aSelf = static_cast<NCollection_Vector1&> (theVector);
...
void NCollection_Vector1<TheItemType>::Assign (const NCollection_Vector1& theOther,
                                              const Standard_Boolean    theOwnAllocator)
{
  ...
  myCapacity  = GetCapacity1 (myIncrement) + myLength / myIncrement;
...
#endif // NCollection_Vector1_HeaderFile
