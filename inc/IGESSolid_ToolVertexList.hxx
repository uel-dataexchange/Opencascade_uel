...
#ifndef _IGESSolid_ToolVertexList_HeaderFile
#define _IGESSolid_ToolVertexList_HeaderFile
...
//! Tool to work on a VertexList. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_VertexList)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a VertexList <ent>, from <br>
