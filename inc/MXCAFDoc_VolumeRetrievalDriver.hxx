...
#ifndef _MXCAFDoc_VolumeRetrievalDriver_HeaderFile
#define _MXCAFDoc_VolumeRetrievalDriver_HeaderFile
...
#include <Handle_MXCAFDoc_VolumeRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_VolumeRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_VolumeRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_VolumeRetrievalDriver)
