...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_SeqNodeOfHSequenceOfPnt,Storage_CallBack)

class ShapeSchema_PColgp_SeqNodeOfHSequenceOfPnt : public Storage_CallBack {
public:
  ShapeSchema_PColgp_SeqNodeOfHSequenceOfPnt() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_SeqNodeOfHSequenceOfPnt)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_SeqNodeOfHSequenceOfPnt)
};
#endif
