...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TVertex,Storage_CallBack)

class ShapeSchema_PTopoDS_TVertex : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TVertex() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TVertex)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TVertex)
};
#endif
