...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray1OfVec,Storage_CallBack)

class ShapeSchema_PColgp_HArray1OfVec : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray1OfVec() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray1OfVec)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray1OfVec)
};
#endif
