...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_RectangularTrimmedSurface,Storage_CallBack)

class ShapeSchema_PGeom_RectangularTrimmedSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_RectangularTrimmedSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_RectangularTrimmedSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_RectangularTrimmedSurface)
};
#endif
