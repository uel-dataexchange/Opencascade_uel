...
#define _Handle_ExprIntrp_SequenceNodeOfSequenceOfNamedFunction_HeaderFile
...
DEFINE_STANDARD_HANDLE(ExprIntrp_SequenceNodeOfSequenceOfNamedFunction,TCollection_SeqNode)
