...
#ifndef _STEPConstruct_DefProps_HeaderFile
#define _STEPConstruct_DefProps_HeaderFile
...
class STEPConstruct_DefProps  : public STEPConstruct_Tool
{
public:
  ...
  Standard_EXPORT STEPConstruct_DefProps();
  
  //! Creates a tool and loads it with worksession
  Standard_EXPORT STEPConstruct_DefProps(const Handle(XSControl_WorkSession)& WS);
  ...
  //! Searches for entities of the type PropertyDefinitionRepresentation
  //! in the model and fills the sequence by them
  Standard_EXPORT Standard_Boolean LoadPropsDef(TColStd_SequenceOfTransient& seq) const;
  ...
  //! Returns GRI associated with given PpD or NULL if not found
  Standard_EXPORT Handle(StepGeom_GeometricRepresentationItem) GetPropGRI(const Handle(StepRepr_PropertyDefinition)& PD) const;
  ...
  Standard_EXPORT Standard_Boolean GetPropInteger(const Handle(StepRepr_RepresentationItem)& item, Standard_Integer& Val) const;
  Standard_EXPORT Standard_Boolean GetPropString(const Handle(StepRepr_RepresentationItem)& item, Standard_CString& Val) const;
...
#endif // _STEPConstruct_DefProps_HeaderFile
