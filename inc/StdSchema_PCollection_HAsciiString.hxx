...
DEFINE_STANDARD_HANDLE(StdSchema_PCollection_HAsciiString,Storage_CallBack)

class StdSchema_PCollection_HAsciiString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PCollection_HAsciiString)
};
#endif
