...
#ifndef _Expr_Sine_HeaderFile
#define _Expr_Sine_HeaderFile
...
#endif
#ifndef _Handle_Expr_Sine_HeaderFile
...
public:
  ...
  //! Creates the sine of <exp>. <br>
  Standard_EXPORT   Expr_Sine(const Handle(Expr_GeneralExpression)& exp);
...
//!          in <vars> or NumericError if result cannot be computed. <br>
  ...
  DEFINE_STANDARD_RTTI(Expr_Sine)
