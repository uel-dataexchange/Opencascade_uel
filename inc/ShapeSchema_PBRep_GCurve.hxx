...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_GCurve,Storage_CallBack)

class ShapeSchema_PBRep_GCurve : public Storage_CallBack {
public:
  ShapeSchema_PBRep_GCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_GCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_GCurve)
};
#endif
