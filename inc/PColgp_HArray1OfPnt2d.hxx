...
PColgp_HArray1OfPnt2d(const Storage_stCONSTclCOM& a) : Standard_Persistent(a)
{
  
}
    Standard_Integer _CSFDB_GetPColgp_HArray1OfPnt2dLowerBound() const { return LowerBound; }
    void _CSFDB_SetPColgp_HArray1OfPnt2dLowerBound(const Standard_Integer p) { LowerBound = p; }
    Standard_Integer _CSFDB_GetPColgp_HArray1OfPnt2dUpperBound() const { return UpperBound; }
    void _CSFDB_SetPColgp_HArray1OfPnt2dUpperBound(const Standard_Integer p) { UpperBound = p; }
    const PColgp_FieldOfHArray1OfPnt2d& _CSFDB_GetPColgp_HArray1OfPnt2dData() const { return Data; }



  DEFINE_STANDARD_RTTI(PColgp_HArray1OfPnt2d)
...
#define PCollection_FieldOfHArray1_hxx <PColgp_FieldOfHArray1OfPnt2d.hxx>
#define PCollection_VArrayNodeOfFieldOfHArray1 PColgp_VArrayNodeOfFieldOfHArray1OfPnt2d
#define PCollection_VArrayNodeOfFieldOfHArray1_hxx <PColgp_VArrayNodeOfFieldOfHArray1OfPnt2d.hxx>
#define PCollection_VArrayTNodeOfFieldOfHArray1 PColgp_VArrayTNodeOfFieldOfHArray1OfPnt2d
#define PCollection_VArrayTNodeOfFieldOfHArray1_hxx <PColgp_VArrayTNodeOfFieldOfHArray1OfPnt2d.hxx>
#define PCollection_VArrayNodeOfFieldOfHArray1 PColgp_VArrayNodeOfFieldOfHArray1OfPnt2d
#define PCollection_VArrayNodeOfFieldOfHArray1_hxx <PColgp_VArrayNodeOfFieldOfHArray1OfPnt2d.hxx>
#define PCollection_VArrayTNodeOfFieldOfHArray1 PColgp_VArrayTNodeOfFieldOfHArray1OfPnt2d
#define PCollection_VArrayTNodeOfFieldOfHArray1_hxx <PColgp_VArrayTNodeOfFieldOfHArray1OfPnt2d.hxx>
...
#define PCollection_HArray1_hxx <PColgp_HArray1OfPnt2d.hxx>
...
inline void ShallowDump(const Handle_PColgp_HArray1OfPnt2d& me,Standard_OStream& s) {
 me->ShallowDump(s);
}
