...
#define _Handle_Dynamic_AbstractVariableInstance_HeaderFile
...
class Handle(Dynamic_Variable);
class Dynamic_AbstractVariableInstance;

DEFINE_STANDARD_HANDLE(Dynamic_AbstractVariableInstance,Dynamic_Variable)
