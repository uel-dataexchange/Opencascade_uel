...
#define _PColPGeom_FieldOfHArray2OfBezierSurface_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColPGeom_FieldOfHArray2OfBezierSurface);
...
public:
  ...
  Standard_EXPORT   PColPGeom_FieldOfHArray2OfBezierSurface(const Standard_Integer Size);
  
  Standard_EXPORT   PColPGeom_FieldOfHArray2OfBezierSurface(const PColPGeom_FieldOfHArray2OfBezierSurface& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColPGeom_FieldOfHArray2OfBezierSurface& Other) ;
    void operator =(const PColPGeom_FieldOfHArray2OfBezierSurface& Other) 
{
  Assign(Other);
}
  
  Standard_EXPORT     void SetValue(const Standard_Integer Index,const Handle(PGeom_BezierSurface)& Value) ;
  
  Standard_EXPORT     Handle_PGeom_BezierSurface& Value(const Standard_Integer Index) const;
