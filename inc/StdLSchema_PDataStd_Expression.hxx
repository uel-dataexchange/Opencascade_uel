...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Expression,Storage_CallBack)

class StdLSchema_PDataStd_Expression : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Expression() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Expression)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Expression)
};
#endif
