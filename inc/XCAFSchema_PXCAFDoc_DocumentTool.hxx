...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_DocumentTool,Storage_CallBack)

class XCAFSchema_PXCAFDoc_DocumentTool : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_DocumentTool() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_DocumentTool)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_DocumentTool)
};
#endif
