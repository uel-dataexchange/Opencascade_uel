...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Location,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Location : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Location() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Location)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Location)
};
#endif
