...
#ifndef _IGESGeom_ToolConicArc_HeaderFile
#define _IGESGeom_ToolConicArc_HeaderFile
...
//! Tool to work on a ConicArc. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_ConicArc)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a ConicArc <ent>, from <br>
//!           its specific (own) parameters <br>
  ...
  //! Sets automatic unambiguous Correction on a ConicArc <br>
//!           (FormNumber recomputed according case Ellips-Parab-Hyperb) <br>
  Standard_EXPORT     Standard_Boolean OwnCorrect(const Handle(IGESGeom_ConicArc)& ent) const;
  //! Returns specific DirChecker <br>
  Standard_EXPORT     IGESData_DirChecker DirChecker(const Handle(IGESGeom_ConicArc)& ent) const;
