...
#ifndef _MDataStd_RealArrayStorageDriver_HeaderFile
#define _MDataStd_RealArrayStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_RealArrayStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_RealArrayStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: RealArray from TDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_RealArrayStorageDriver)
