...
#ifndef _MXCAFDoc_ColorToolRetrievalDriver_HeaderFile
#define _MXCAFDoc_ColorToolRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_ColorToolRetrievalDriver_HeaderFile
#include <Handle_MXCAFDoc_ColorToolRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_ColorToolRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_ColorToolRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_ColorToolRetrievalDriver)
