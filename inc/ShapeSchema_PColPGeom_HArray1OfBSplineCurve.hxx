...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom_HArray1OfBSplineCurve,Storage_CallBack)

class ShapeSchema_PColPGeom_HArray1OfBSplineCurve : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom_HArray1OfBSplineCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom_HArray1OfBSplineCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom_HArray1OfBSplineCurve)
};
#endif
