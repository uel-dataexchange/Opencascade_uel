...
#ifndef _MXCAFDoc_LayerToolRetrievalDriver_HeaderFile
#define _MXCAFDoc_LayerToolRetrievalDriver_HeaderFile
...
#include <Handle_MXCAFDoc_LayerToolRetrievalDriver.hxx>
#endif
...
class MXCAFDoc_LayerToolRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_LayerToolRetrievalDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_LayerToolRetrievalDriver)
