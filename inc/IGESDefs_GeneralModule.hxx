...
//! Definition of General Services for IGESDefs (specific part) <br>
//!           This Services comprise : Shared & Implied Lists, Copy, Check <br>
class IGESDefs_GeneralModule : public IGESData_GeneralModule {

public:

  //! Creates a GeneralModule from IGESDefs and puts it into GeneralLib <br>
...
//!           Auxiliary for all <br>
  ...
  DEFINE_STANDARD_RTTI(IGESDefs_GeneralModule)
