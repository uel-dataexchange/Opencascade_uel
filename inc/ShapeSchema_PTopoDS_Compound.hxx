...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_Compound,Storage_CallBack)

class ShapeSchema_PTopoDS_Compound : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_Compound() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_Compound)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_Compound)
};
#endif
