...
DEFINE_STANDARD_HANDLE(XCAFSchema_PCollection_HExtendedString,Storage_CallBack)

class XCAFSchema_PCollection_HExtendedString : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PCollection_HExtendedString)
};
#endif
