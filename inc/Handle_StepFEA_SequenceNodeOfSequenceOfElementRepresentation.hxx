...
#define _Handle_StepFEA_SequenceNodeOfSequenceOfElementRepresentation_HeaderFile
...
DEFINE_STANDARD_HANDLE(StepFEA_SequenceNodeOfSequenceOfElementRepresentation,TCollection_SeqNode)
