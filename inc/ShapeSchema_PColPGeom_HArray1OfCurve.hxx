...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom_HArray1OfCurve,Storage_CallBack)

class ShapeSchema_PColPGeom_HArray1OfCurve : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom_HArray1OfCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom_HArray1OfCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom_HArray1OfCurve)
};
#endif
