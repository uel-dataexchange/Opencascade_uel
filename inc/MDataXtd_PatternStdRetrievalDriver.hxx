...
#ifndef _MDataXtd_PatternStdRetrievalDriver_HeaderFile
#define _MDataXtd_PatternStdRetrievalDriver_HeaderFile
...
#include <Handle_MDataXtd_PatternStdRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_PatternStdRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: PatternStd from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_PatternStdRetrievalDriver)
