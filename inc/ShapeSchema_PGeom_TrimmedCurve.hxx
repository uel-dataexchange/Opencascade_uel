...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_TrimmedCurve,Storage_CallBack)

class ShapeSchema_PGeom_TrimmedCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_TrimmedCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_TrimmedCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_TrimmedCurve)
};
#endif
