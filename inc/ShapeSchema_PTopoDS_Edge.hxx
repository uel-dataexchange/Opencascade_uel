...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_Edge,Storage_CallBack)

class ShapeSchema_PTopoDS_Edge : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_Edge() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_Edge)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_Edge)
};
#endif
