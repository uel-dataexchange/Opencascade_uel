...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_TreeNode,Storage_CallBack)

class StdLSchema_PDataStd_TreeNode : public Storage_CallBack {
public:
  StdLSchema_PDataStd_TreeNode() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_TreeNode)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_TreeNode)
};
#endif
