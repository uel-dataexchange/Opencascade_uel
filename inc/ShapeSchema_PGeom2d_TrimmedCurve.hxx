...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_TrimmedCurve,Storage_CallBack)

class ShapeSchema_PGeom2d_TrimmedCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_TrimmedCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_TrimmedCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_TrimmedCurve)
};
#endif
