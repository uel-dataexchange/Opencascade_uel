...
#define _Handle_ExprIntrp_SequenceNodeOfSequenceOfNamedExpression_HeaderFile
...
DEFINE_STANDARD_HANDLE(ExprIntrp_SequenceNodeOfSequenceOfNamedExpression,TCollection_SeqNode)
