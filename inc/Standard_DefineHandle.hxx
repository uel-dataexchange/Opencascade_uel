...
#define DEFINE_STANDARD_RTTIEXT(C1, Base) \
Standard_EXPORT virtual const Handle(Standard_Type)& DynamicType() const;

#define DEFINE_STANDARD_RTTI_INLINE(C1, Base) \
virtual const Handle(Standard_Type)& DynamicType() const;
...
#define IMPLEMENT_STANDARD_RTTIEXT_1(C1,C2) \
IMPLEMENT_STANDARD_RTTI(C1) \
IMPLEMENT_STANDARD_TYPE(C1) \
IMPLEMENT_STANDARD_SUPERTYPE(C2) \
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY() \
