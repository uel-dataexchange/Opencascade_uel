...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray2OfVec,Storage_CallBack)

class ShapeSchema_PColgp_HArray2OfVec : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray2OfVec() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray2OfVec)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray2OfVec)
};
#endif
