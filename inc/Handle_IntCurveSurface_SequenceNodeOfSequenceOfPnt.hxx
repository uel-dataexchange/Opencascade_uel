...
#define _Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt_HeaderFile
...
DEFINE_STANDARD_HANDLE(IntCurveSurface_SequenceNodeOfSequenceOfPnt,TCollection_SeqNode)
