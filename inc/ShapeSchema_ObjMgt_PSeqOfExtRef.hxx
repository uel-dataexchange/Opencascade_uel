...
DEFINE_STANDARD_HANDLE(ShapeSchema_ObjMgt_PSeqOfExtRef,Storage_CallBack)

class ShapeSchema_ObjMgt_PSeqOfExtRef : public Storage_CallBack {
public:
  ShapeSchema_ObjMgt_PSeqOfExtRef() {}
  Standard_EXPORT static void SAdd(const Handle(ObjMgt_PSeqOfExtRef)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_ObjMgt_PSeqOfExtRef)
};
#endif
