...
#define _TDF_MapIteratorOfLabelMap_HeaderFile
...
public:
  ...
  Standard_EXPORT   TDF_MapIteratorOfLabelMap(const TDF_LabelMap& aMap);
  
  Standard_EXPORT     void Initialize(const TDF_LabelMap& aMap) ;
