...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray2OfVec2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray2OfVec2d,PStandard_ArrayNode)
