...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Point,Storage_CallBack)

class ShapeSchema_PGeom2d_Point : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Point() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Point)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Point)
};
#endif
