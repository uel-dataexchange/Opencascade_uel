...
#ifndef _MDataStd_NameRetrievalDriver_HeaderFile
#define _MDataStd_NameRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_NameRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_NameRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Name from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_NameRetrievalDriver)
