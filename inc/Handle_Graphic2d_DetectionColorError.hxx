...
#define _Handle_Graphic2d_DetectionColorError_HeaderFile
...
class Graphic2d_DetectionColorError;

DEFINE_STANDARD_HANDLE(Graphic2d_DetectionColorError,Standard_OutOfRange)
