...
#ifndef _IGESGeom_ToolSplineCurve_HeaderFile
#define _IGESGeom_ToolSplineCurve_HeaderFile
...
//! Tool to work on a SplineCurve. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_SplineCurve)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a SplineCurve <ent>, from <br>
