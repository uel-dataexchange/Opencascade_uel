...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Plane,Storage_CallBack)

class StdSchema_PDataXtd_Plane : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Plane() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Plane)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Plane)
};
#endif
