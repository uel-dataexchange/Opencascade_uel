...
#endif
#ifndef _Handle_StepFEA_HSequenceOfNodeRepresentation_HeaderFile
...
public:
  ...
  Standard_EXPORT     Handle_StepFEA_HSequenceOfNodeRepresentation Split(const Standard_Integer anIndex) ;
  
  Standard_EXPORT     void SetValue(const Standard_Integer anIndex,const Handle(StepFEA_NodeRepresentation)& anItem) ;
  
  Standard_EXPORT    const Handle_StepFEA_NodeRepresentation& Value(const Standard_Integer anIndex) const;
  
  Standard_EXPORT     Handle_StepFEA_NodeRepresentation& ChangeValue(const Standard_Integer anIndex) ;
  ...
  Standard_EXPORT     Handle_StepFEA_HSequenceOfNodeRepresentation ShallowCopy() const;
...
inline Handle_StepFEA_HSequenceOfNodeRepresentation ShallowCopy(const Handle_StepFEA_HSequenceOfNodeRepresentation& me) {
