...
#define _PColPGeom_FieldOfHArray2OfSurface_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColPGeom_FieldOfHArray2OfSurface);
...
public:
  ...
  Standard_EXPORT   PColPGeom_FieldOfHArray2OfSurface(const Standard_Integer Size);
  
  Standard_EXPORT   PColPGeom_FieldOfHArray2OfSurface(const PColPGeom_FieldOfHArray2OfSurface& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColPGeom_FieldOfHArray2OfSurface& Other) ;
