...
#define _Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint_HeaderFile
...
DEFINE_STANDARD_HANDLE(IntSurf_SequenceNodeOfSequenceOfPathPoint,TCollection_SeqNode)
