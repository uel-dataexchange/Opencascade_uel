...
#endif
#ifndef _Handle_IGESAppli_GeneralModule_HeaderFile
...
//! Definition of General Services for IGESAppli (specific part) <br>
//!           This Services comprise : Shared & Implied Lists, Copy, Check <br>
class IGESAppli_GeneralModule : public IGESData_GeneralModule {

public:

  //! Creates a GeneralModule from IGESAppli and puts it into GeneralLib <br>
...
//!           FEA for : ElementResults,FiniteElement,Node&Co <br>
//!           Piping for : Flow & Co <br>
//!           Professional for : others (in fact Schematics) <br>
