...
#ifndef _IGESDimen_ToolAngularDimension_HeaderFile
#define _IGESDimen_ToolAngularDimension_HeaderFile
...
//! Tool to work on a AngularDimension. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESDimen_AngularDimension)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESDimen_AngularDimension)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a AngularDimension <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESDimen_AngularDimension)& ent,Interface_EntityIterator& iter) const;
