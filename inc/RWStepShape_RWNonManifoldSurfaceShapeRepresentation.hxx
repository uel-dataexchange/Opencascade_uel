...
//! Read & Write tool for NonManifoldSurfaceShapeRepresentation <br>
...
public:
  ...
  //! Reads NonManifoldSurfaceShapeRepresentation <br>
  ...
  //! Writes NonManifoldSurfaceShapeRepresentation <br>
