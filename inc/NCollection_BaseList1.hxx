...
//              objects of class NCollection_ListNode1).
...
#ifndef NCollection_BaseList1_HeaderFile
#define NCollection_BaseList1_HeaderFile
...
typedef void (* NCollection_DelListNode1) 
     (NCollection_ListNode1*, Handle(NCollection_BaseAllocator)& theAl);

// ********************************************************** BaseList class
class NCollection_BaseList1
{
public:
  //! Memory allocation
...
public:
  ...
  public:
    ...
    Iterator  (const NCollection_BaseList1& theList) :
      myCurrent (theList.myFirst),
      myPrevious(NULL) {}
    // ******** Initialisation
    void Init (const NCollection_BaseList1& theList)
    {
      myCurrent  = theList.myFirst;
      myPrevious = NULL;
    }
    // ******** Initialisation
    void Initialize (const NCollection_BaseList1& theList)
    {
      Init(theList);
    }
    // ******** More
...
//-------------------------------------------------------
  ...
  protected:
    void Init (const NCollection_BaseList1& theList,
               NCollection_ListNode1 * const thePrev)
    {
      myCurrent  = thePrev ? thePrev -> Next() :
                             (NCollection_ListNode1 *)theList.PLast();
      myPrevious = thePrev;
    }
  public:
    NCollection_ListNode1 * myCurrent; // Pointer to the current node
    NCollection_ListNode1 * myPrevious;// Pointer to the previous one
    friend class NCollection_BaseList1;
 ...
 public:
  ...
  virtual ~NCollection_BaseList1 (void)
  {}
 ...
 protected:
  ...
  NCollection_BaseList1 (const Handle(NCollection_BaseAllocator)& theAllocator=0L) :
    myFirst(NULL),
    myLast(NULL),
    myLength(0)
  {
  ...
  Standard_EXPORT void PClear (NCollection_DelListNode1 fDel);

  // ******** PFirst
  // Purpose: Returns pointer to the first node
  const NCollection_ListNode1* PFirst (void) const
  { return myFirst; }

  // ******** PLast
  // Purpose: Returns pointer to the last node
  const NCollection_ListNode1* PLast (void) const
  { return myLast; }

  // ******** PAppend
  // Purpose: Appends theNode at the end
  Standard_EXPORT void PAppend (NCollection_ListNode1* theNode);

  // ******** PAppend
  // Purpose: Appends theNode at the end, returns iterator to the previous
  void                 PAppend (NCollection_ListNode1* theNode,
                                Iterator&             theIt)
  {
    NCollection_ListNode1 * aPrev = myLast;
    PAppend (theNode);
  ...
  Standard_EXPORT void PAppend (NCollection_BaseList1& theOther);

  // ******** PPrepend
  // Purpose: Prepends theNode at the beginning
  Standard_EXPORT void PPrepend (NCollection_ListNode1* theNode);

  // ******** PPrepend
  // Purpose: Prepends theOther list at the beginning (clearing it)
  Standard_EXPORT void PPrepend (NCollection_BaseList1& theOther);

  // ******** PRemoveFirst
  // Purpose: Removes first node
  Standard_EXPORT void PRemoveFirst 
    (NCollection_DelListNode1 fDel);
  ...
  Standard_EXPORT void PInsertBefore (NCollection_ListNode1* theNode,
                                      Iterator& theIter);

  // ******** PInsertBefore
  // Purpose: Inserts theOther list before the node pointed by theIter[ator]
  Standard_EXPORT void PInsertBefore (NCollection_BaseList1& theOther,
                                      Iterator& theIter);

  // ******** PInsertAfter
  // Purpose: Inserts theNode after one pointed by theIter[ator]
  Standard_EXPORT void PInsertAfter (NCollection_ListNode1* theNode,
                                     Iterator& theIter);

  // ******** PInsertAfter
  // Purpose: Inserts theOther list after the node pointed by theIter[ator]
  Standard_EXPORT void PInsertAfter (NCollection_BaseList1& theOther,
                                     Iterator& theIter);
 ...
 protected:
  ...
  NCollection_ListNode1 * myFirst;  // Pointer to the head
  NCollection_ListNode1 * myLast;   // Pointer to the tail
