...
//! Read & Write tool for StructuralResponsePropertyDefinitionRepresentation <br>
...
public:
  ...
  //! Reads StructuralResponsePropertyDefinitionRepresentation <br>
  ...
  //! Writes StructuralResponsePropertyDefinitionRepresentation <br>
