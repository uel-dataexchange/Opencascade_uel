...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Tick,Storage_CallBack)

class StdLSchema_PDataStd_Tick : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Tick() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Tick)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Tick)
};
#endif
