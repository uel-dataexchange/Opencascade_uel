...
#endif
#ifndef _Handle_PDataXtd_Geometry_HeaderFile
...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Geometry,Storage_CallBack)

class StdSchema_PDataXtd_Geometry : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Geometry() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Geometry)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Geometry)
};
#endif
