...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Axis1Placement,Storage_CallBack)

class ShapeSchema_PGeom_Axis1Placement : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Axis1Placement() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Axis1Placement)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Axis1Placement)
};
#endif
