...
#ifndef _MXCAFDoc_LayerToolStorageDriver_HeaderFile
#define _MXCAFDoc_LayerToolStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MXCAFDoc_LayerToolStorageDriver_HeaderFile
#include <Handle_MXCAFDoc_LayerToolStorageDriver.hxx>
#endif
...
class MXCAFDoc_LayerToolStorageDriver : public MDF_ASDriver {

public:

  
  Standard_EXPORT   MXCAFDoc_LayerToolStorageDriver(const Handle(CDM_MessageDriver)& theMsgDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: XCAFDoc_Layer. <br>
  ...
  DEFINE_STANDARD_RTTI(MXCAFDoc_LayerToolStorageDriver)
