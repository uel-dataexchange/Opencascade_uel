...
#endif
#ifndef _Handle_PXCAFDoc_DimTolTool_HeaderFile
...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_DimTolTool,Storage_CallBack)

class XCAFSchema_PXCAFDoc_DimTolTool : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_DimTolTool() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_DimTolTool)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_DimTolTool)
};
#endif
