...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopLoc_Datum3D,Storage_CallBack)

class ShapeSchema_PTopLoc_Datum3D : public Storage_CallBack {
public:
  ShapeSchema_PTopLoc_Datum3D() {}
  Standard_EXPORT static void SAdd(const Handle(PTopLoc_Datum3D)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopLoc_Datum3D)
};
#endif
