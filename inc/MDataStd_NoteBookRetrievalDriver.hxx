...
#ifndef _MDataStd_NoteBookRetrievalDriver_HeaderFile
#define _MDataStd_NoteBookRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_NoteBookRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_NoteBookRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: NoteBook from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_NoteBookRetrievalDriver)
