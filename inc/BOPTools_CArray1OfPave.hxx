...
#define _BOPTools_CArray1OfPave_HeaderFile
...
~BOPTools_CArray1OfPave()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_Pave& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_Pave& Value(const Standard_Integer Index) const;
   const BOPTools_Pave& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_Pave& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CArray1OfPave(const BOPTools_CArray1OfPave& AnArray);
  
  Standard_EXPORT     BOPTools_CArray1OfPave& Assign(const BOPTools_CArray1OfPave& Other) ;
    BOPTools_CArray1OfPave& operator =(const BOPTools_CArray1OfPave& Other) 
{
  return Assign(Other);
}
