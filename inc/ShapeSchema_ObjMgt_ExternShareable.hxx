...
DEFINE_STANDARD_HANDLE(ShapeSchema_ObjMgt_ExternShareable,Storage_CallBack)

class ShapeSchema_ObjMgt_ExternShareable : public Storage_CallBack {
public:
  ShapeSchema_ObjMgt_ExternShareable() {}
  Standard_EXPORT static void SAdd(const Handle(ObjMgt_ExternShareable)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_ObjMgt_ExternShareable)
};
#endif
