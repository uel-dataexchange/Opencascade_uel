...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_UAttribute,Storage_CallBack)

class StdLSchema_PDataStd_UAttribute : public Storage_CallBack {
public:
  StdLSchema_PDataStd_UAttribute() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_UAttribute)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_UAttribute)
};
#endif
