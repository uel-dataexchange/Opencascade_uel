...
DEFINE_STANDARD_HANDLE(StdSchema_PTopLoc_Datum3D,Storage_CallBack)

class StdSchema_PTopLoc_Datum3D : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PTopLoc_Datum3D)
};
#endif
