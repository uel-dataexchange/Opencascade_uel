...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_IntegerList,Storage_CallBack)

class StdLSchema_PDataStd_IntegerList : public Storage_CallBack {
public:
  StdLSchema_PDataStd_IntegerList() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_IntegerList)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_IntegerList)
};
#endif
