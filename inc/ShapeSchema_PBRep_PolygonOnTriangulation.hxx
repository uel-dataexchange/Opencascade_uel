...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PolygonOnTriangulation,Storage_CallBack)

class ShapeSchema_PBRep_PolygonOnTriangulation : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PolygonOnTriangulation() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PolygonOnTriangulation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PolygonOnTriangulation)
};
#endif
