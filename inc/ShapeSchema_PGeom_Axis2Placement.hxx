...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Axis2Placement,Storage_CallBack)

class ShapeSchema_PGeom_Axis2Placement : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Axis2Placement() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Axis2Placement)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Axis2Placement)
};
#endif
