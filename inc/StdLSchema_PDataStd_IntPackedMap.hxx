...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_IntPackedMap,Storage_CallBack)

class StdLSchema_PDataStd_IntPackedMap : public Storage_CallBack {
public:
  StdLSchema_PDataStd_IntPackedMap() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_IntPackedMap)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_IntPackedMap)
};
#endif
