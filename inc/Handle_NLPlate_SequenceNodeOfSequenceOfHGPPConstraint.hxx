...
#define _Handle_NLPlate_SequenceNodeOfSequenceOfHGPPConstraint_HeaderFile
...
DEFINE_STANDARD_HANDLE(NLPlate_SequenceNodeOfSequenceOfHGPPConstraint,TCollection_SeqNode)
