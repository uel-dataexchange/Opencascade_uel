...
#define _PColgp_FieldOfHArray2OfXYZ_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColgp_FieldOfHArray2OfXYZ);
...
public:
  ...
  Standard_EXPORT   PColgp_FieldOfHArray2OfXYZ(const Standard_Integer Size);
  
  Standard_EXPORT   PColgp_FieldOfHArray2OfXYZ(const PColgp_FieldOfHArray2OfXYZ& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColgp_FieldOfHArray2OfXYZ& Other) ;
