...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TShape1,Storage_CallBack)

class ShapeSchema_PTopoDS_TShape1 : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TShape1)
};
#endif
