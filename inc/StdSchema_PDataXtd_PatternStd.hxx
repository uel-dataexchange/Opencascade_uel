...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_PatternStd,Storage_CallBack)

class StdSchema_PDataXtd_PatternStd : public Storage_CallBack {
public:
  StdSchema_PDataXtd_PatternStd() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_PatternStd)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_PatternStd)
};
#endif
