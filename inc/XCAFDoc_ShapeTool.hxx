...
public:
  ...
  Standard_EXPORT void GetShapes (TDF_LabelSequence1& Labels) const;
  
  //! Returns a sequence of all top-level shapes
  //! which are free (i.e. not referred by any other)
  Standard_EXPORT void GetFreeShapes (TDF_LabelSequence1& FreeLabels) const;
  
  //! Returns list of labels which refer shape L as component
  //! Returns number of users (0 if shape is free)
  Standard_EXPORT static Standard_Integer GetUsers (const TDF_Label& L, TDF_LabelSequence1& Labels, const Standard_Boolean getsubchilds = Standard_False);
  ...
  Standard_EXPORT static Standard_Boolean GetComponents (const TDF_Label& L, TDF_LabelSequence1& Labels, const Standard_Boolean getsubchilds = Standard_False);
  ...
  Standard_EXPORT static Standard_Boolean GetSubShapes (const TDF_Label& L, TDF_LabelSequence1& Labels);
  ...
  Standard_EXPORT Standard_Boolean SetSHUO (const TDF_LabelSequence1& Labels, Handle(XCAFDoc_GraphNode)& MainSHUOAttr) const;
  ...
  Standard_EXPORT static Standard_Boolean GetSHUOUpperUsage (const TDF_Label& NextUsageL, TDF_LabelSequence1& Labels);
  ...
  //! NOTE: do not clear the sequence before filling
  Standard_EXPORT static Standard_Boolean GetSHUONextUsage (const TDF_Label& UpperUsageL, TDF_LabelSequence1& Labels);
  ...
  Standard_EXPORT Standard_Boolean FindComponent (const TopoDS_Shape& theShape, TDF_LabelSequence1& Labels) const;
  ...
  Standard_EXPORT static Standard_Boolean FindSHUO (const TDF_LabelSequence1& Labels, Handle(XCAFDoc_GraphNode)& theSHUOAttr);
