...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Centroid,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Centroid : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Centroid() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Centroid)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Centroid)
};
#endif
