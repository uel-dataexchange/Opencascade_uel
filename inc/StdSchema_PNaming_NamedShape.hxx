...
DEFINE_STANDARD_HANDLE(StdSchema_PNaming_NamedShape,Storage_CallBack)

class StdSchema_PNaming_NamedShape : public Storage_CallBack {
public:
  StdSchema_PNaming_NamedShape() {}
  Standard_EXPORT static void SAdd(const Handle(PNaming_NamedShape)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PNaming_NamedShape)
};
#endif
