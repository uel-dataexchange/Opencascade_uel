...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TShell,Storage_CallBack)

class ShapeSchema_PTopoDS_TShell : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TShell() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TShell)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TShell)
};
#endif
