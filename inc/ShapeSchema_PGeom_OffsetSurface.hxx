...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_OffsetSurface,Storage_CallBack)

class ShapeSchema_PGeom_OffsetSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_OffsetSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_OffsetSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_OffsetSurface)
};
#endif
