...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColStd_HArray1OfReal,Storage_CallBack)

class ShapeSchema_PColStd_HArray1OfReal : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColStd_HArray1OfReal)
};
#endif
