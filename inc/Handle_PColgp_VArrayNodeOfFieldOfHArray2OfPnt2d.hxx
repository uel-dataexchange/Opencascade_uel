...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray2OfPnt2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray2OfPnt2d,PStandard_ArrayNode)
