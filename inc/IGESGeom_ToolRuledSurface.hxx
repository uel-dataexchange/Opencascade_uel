...
#ifndef _IGESGeom_ToolRuledSurface_HeaderFile
#define _IGESGeom_ToolRuledSurface_HeaderFile
...
//! Tool to work on a RuledSurface. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESGeom_RuledSurface)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESGeom_RuledSurface)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a RuledSurface <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESGeom_RuledSurface)& ent,Interface_EntityIterator& iter) const;
