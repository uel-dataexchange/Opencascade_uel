...
#define _Handle_IntTools_SequenceNodeOfSequenceOfCommonPrts_HeaderFile
...
DEFINE_STANDARD_HANDLE(IntTools_SequenceNodeOfSequenceOfCommonPrts,TCollection_SeqNode)
