...
#ifndef _IGESDimen_ToolPointDimension_HeaderFile
#define _IGESDimen_ToolPointDimension_HeaderFile
...
//! Tool to work on a PointDimension. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESDimen_PointDimension)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  //! Writes own parameters to IGESWriter <br>
  Standard_EXPORT     void WriteOwnParams(const Handle(IGESDimen_PointDimension)& ent,IGESData_IGESWriter& IW) const;
  //! Lists the Entities shared by a PointDimension <ent>, from <br>
//!           its specific (own) parameters <br>
  Standard_EXPORT     void OwnShared(const Handle(IGESDimen_PointDimension)& ent,Interface_EntityIterator& iter) const;
