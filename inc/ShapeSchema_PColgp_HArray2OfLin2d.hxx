...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray2OfLin2d,Storage_CallBack)

class ShapeSchema_PColgp_HArray2OfLin2d : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray2OfLin2d() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray2OfLin2d)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray2OfLin2d)
};
#endif
