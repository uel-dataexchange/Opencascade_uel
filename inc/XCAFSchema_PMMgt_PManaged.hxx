...
DEFINE_STANDARD_HANDLE(XCAFSchema_PMMgt_PManaged,Storage_CallBack)

class XCAFSchema_PMMgt_PManaged : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PMMgt_PManaged)
};
#endif
