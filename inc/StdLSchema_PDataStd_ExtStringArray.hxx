...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_ExtStringArray,Storage_CallBack)

class StdLSchema_PDataStd_ExtStringArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_ExtStringArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_ExtStringArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_ExtStringArray)
};
#endif
