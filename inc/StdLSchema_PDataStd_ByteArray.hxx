...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_ByteArray,Storage_CallBack)

class StdLSchema_PDataStd_ByteArray : public Storage_CallBack {
public:
  StdLSchema_PDataStd_ByteArray() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_ByteArray)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_ByteArray)
};
#endif
