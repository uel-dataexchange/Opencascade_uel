...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HArray1OfXYZ,Storage_CallBack)

class ShapeSchema_PColgp_HArray1OfXYZ : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HArray1OfXYZ() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HArray1OfXYZ)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HArray1OfXYZ)
};
#endif
