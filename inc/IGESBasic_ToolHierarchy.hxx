...
//! Tool to work on a Hierarchy. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESBasic_Hierarchy)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Hierarchy <ent>, from <br>
//!           its specific (own) parameters <br>
  ...
  //! Sets automatic unambiguous Correction on a Hierarchy <br>
//!           (NbPropertyValues forced to 6) <br>
