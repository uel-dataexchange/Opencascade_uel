...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Ellipse,Storage_CallBack)

class ShapeSchema_PGeom_Ellipse : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Ellipse() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Ellipse)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Ellipse)
};
#endif
