...
#include <TColStd_HArray1OfByte1.hxx>
...
public:
  ...
  Standard_EXPORT void GetNotes(TDF_LabelSequence1& theNoteLabels) const;

  //! Returns all labels from the annotated items hive.
  //! The label sequence isn't cleared beforehand.
  //! \param [out] theNoteLabels - sequence of labels.
  Standard_EXPORT void GetAnnotatedItems(TDF_LabelSequence1& theLabels) const;
  ...
  Standard_EXPORT Standard_Integer DeleteNotes(TDF_LabelSequence1& theNoteLabels);
  ...
  //! The label sequence isn't cleared beforehand.
  //! \param [out] theNoteLabels - sequence of labels.
  Standard_EXPORT void GetOrphanNotes(TDF_LabelSequence1& theNoteLabels) const;
