...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_HArray1OfHShape,Storage_CallBack)

class ShapeSchema_PTopoDS_HArray1OfHShape : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_HArray1OfHShape() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_HArray1OfHShape)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_HArray1OfHShape)
};
#endif
