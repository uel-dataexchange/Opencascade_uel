   ...
   const StepFEA_SequenceOfElementGeometricRelationship& operator =(const StepFEA_SequenceOfElementGeometricRelationship& Other) 
{
  ...
  Standard_EXPORT    const Handle_StepFEA_ElementGeometricRelationship& First() const;
  
  Standard_EXPORT    const Handle_StepFEA_ElementGeometricRelationship& Last() const;
  
        void Split(const Standard_Integer Index,StepFEA_SequenceOfElementGeometricRelationship& Sub) ;
  
  Standard_EXPORT    const Handle_StepFEA_ElementGeometricRelationship& Value(const Standard_Integer Index) const;
   const Handle_StepFEA_ElementGeometricRelationship& operator()(const Standard_Integer Index) const
{
  ...
  Standard_EXPORT     Handle_StepFEA_ElementGeometricRelationship& ChangeValue(const Standard_Integer Index) ;
