...
#ifndef _IGESSolid_ToolConicalSurface_HeaderFile
#define _IGESSolid_ToolConicalSurface_HeaderFile
...
//! Tool to work on a ConicalSurface. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_ConicalSurface)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a ConicalSurface <ent>, from <br>
