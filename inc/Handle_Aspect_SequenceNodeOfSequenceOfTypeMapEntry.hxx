...
#define _Handle_Aspect_SequenceNodeOfSequenceOfTypeMapEntry_HeaderFile
...
DEFINE_STANDARD_HANDLE(Aspect_SequenceNodeOfSequenceOfTypeMapEntry,TCollection_SeqNode)
