...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PointRepresentation,Storage_CallBack)

class ShapeSchema_PBRep_PointRepresentation : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PointRepresentation() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PointRepresentation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PointRepresentation)
};
#endif
