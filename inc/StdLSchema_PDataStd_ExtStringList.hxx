...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_ExtStringList,Storage_CallBack)

class StdLSchema_PDataStd_ExtStringList : public Storage_CallBack {
public:
  StdLSchema_PDataStd_ExtStringList() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_ExtStringList)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_ExtStringList)
};
#endif
