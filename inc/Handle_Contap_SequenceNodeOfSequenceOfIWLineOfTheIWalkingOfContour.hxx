...
#define _Handle_Contap_SequenceNodeOfSequenceOfIWLineOfTheIWalkingOfContour_HeaderFile
...
DEFINE_STANDARD_HANDLE(Contap_SequenceNodeOfSequenceOfIWLineOfTheIWalkingOfContour,TCollection_SeqNode)
