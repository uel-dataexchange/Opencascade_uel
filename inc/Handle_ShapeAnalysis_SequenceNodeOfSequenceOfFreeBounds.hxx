...
#define _Handle_ShapeAnalysis_SequenceNodeOfSequenceOfFreeBounds_HeaderFile
...
DEFINE_STANDARD_HANDLE(ShapeAnalysis_SequenceNodeOfSequenceOfFreeBounds,TCollection_SeqNode)
