...
#define _TColStd_Array2OfBoolean_HeaderFile
...
public:
  ...
  Standard_EXPORT   TColStd_Array2OfBoolean(const Standard_Boolean& Item,const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2);
...
~TColStd_Array2OfBoolean()
{
  ...
  Standard_EXPORT    const TColStd_Array2OfBoolean& Assign(const TColStd_Array2OfBoolean& Other) ;
...
private:
  ...
  Standard_EXPORT   TColStd_Array2OfBoolean(const TColStd_Array2OfBoolean& AnArray);
