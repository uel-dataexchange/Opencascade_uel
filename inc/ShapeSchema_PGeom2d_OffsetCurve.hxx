...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_OffsetCurve,Storage_CallBack)

class ShapeSchema_PGeom2d_OffsetCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_OffsetCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_OffsetCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_OffsetCurve)
};
#endif
