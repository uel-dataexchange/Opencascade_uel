...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_CurveOnSurface,Storage_CallBack)

class ShapeSchema_PBRep_CurveOnSurface : public Storage_CallBack {
public:
  ShapeSchema_PBRep_CurveOnSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_CurveOnSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_CurveOnSurface)
};
#endif
