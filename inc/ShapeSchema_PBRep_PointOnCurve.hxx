...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PointOnCurve,Storage_CallBack)

class ShapeSchema_PBRep_PointOnCurve : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PointOnCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PointOnCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PointOnCurve)
};
#endif
