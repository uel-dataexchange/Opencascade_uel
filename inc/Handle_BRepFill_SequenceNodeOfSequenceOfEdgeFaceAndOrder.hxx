...
#define _Handle_BRepFill_SequenceNodeOfSequenceOfEdgeFaceAndOrder_HeaderFile
...
DEFINE_STANDARD_HANDLE(BRepFill_SequenceNodeOfSequenceOfEdgeFaceAndOrder,TCollection_SeqNode)
