...
DEFINE_STANDARD_HANDLE(StdSchema_PTopoDS_HArray1OfShape1,Storage_CallBack)

class StdSchema_PTopoDS_HArray1OfShape1 : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PTopoDS_HArray1OfShape1)
};
#endif
