...
DEFINE_STANDARD_HANDLE(StdSchema_PPrsStd_AISPresentation,Storage_CallBack)

class StdSchema_PPrsStd_AISPresentation : public Storage_CallBack {
public:
  StdSchema_PPrsStd_AISPresentation() {}
  Standard_EXPORT static void SAdd(const Handle(PPrsStd_AISPresentation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PPrsStd_AISPresentation)
};
#endif
