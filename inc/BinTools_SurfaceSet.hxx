...
//! Stores a set of Surfaces from Geom in binary format. <br>
...
//!          its index. <br>
  ...
  //! Writes the content of  me  on the stream <OS> in <br>
...
//! <br>
  ...
  //! Dumps the surface on the stream in binary <br>
//!          format that can be read back. <br>
