...
#ifndef _MDataStd_NamedDataRetrievalDriver_HeaderFile
#define _MDataStd_NamedDataRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_NamedDataRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  ...
  DEFINE_STANDARD_RTTI(MDataStd_NamedDataRetrievalDriver)
