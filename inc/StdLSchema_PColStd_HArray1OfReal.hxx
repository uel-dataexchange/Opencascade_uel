...
DEFINE_STANDARD_HANDLE(StdLSchema_PColStd_HArray1OfReal,Storage_CallBack)

class StdLSchema_PColStd_HArray1OfReal : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PColStd_HArray1OfReal)
};
#endif
