...
DEFINE_STANDARD_HANDLE(ShapeSchema_PPoly_Polygon2D,Storage_CallBack)

class ShapeSchema_PPoly_Polygon2D : public Storage_CallBack {
public:
  ShapeSchema_PPoly_Polygon2D() {}
  Standard_EXPORT static void SAdd(const Handle(PPoly_Polygon2D)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PPoly_Polygon2D)
};
#endif
