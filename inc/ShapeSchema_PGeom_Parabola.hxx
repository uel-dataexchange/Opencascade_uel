...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Parabola,Storage_CallBack)

class ShapeSchema_PGeom_Parabola : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Parabola() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Parabola)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Parabola)
};
#endif
