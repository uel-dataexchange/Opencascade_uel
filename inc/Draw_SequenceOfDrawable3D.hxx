   ...
   const Draw_SequenceOfDrawable3D& operator =(const Draw_SequenceOfDrawable3D& Other) 
{
  ...
  Standard_EXPORT    const Handle_Draw_Drawable3D& First() const;
  
  Standard_EXPORT    const Handle_Draw_Drawable3D& Last() const;
  
        void Split(const Standard_Integer Index,Draw_SequenceOfDrawable3D& Sub) ;
  
  Standard_EXPORT    const Handle_Draw_Drawable3D& Value(const Standard_Integer Index) const;
   const Handle_Draw_Drawable3D& operator()(const Standard_Integer Index) const
{
  ...
  Standard_EXPORT     Handle_Draw_Drawable3D& ChangeValue(const Standard_Integer Index) ;
