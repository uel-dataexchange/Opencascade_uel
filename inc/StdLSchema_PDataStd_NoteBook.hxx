...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_NoteBook,Storage_CallBack)

class StdLSchema_PDataStd_NoteBook : public Storage_CallBack {
public:
  StdLSchema_PDataStd_NoteBook() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_NoteBook)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_NoteBook)
};
#endif
