...
#ifndef _MDataStd_TreeNodeStorageDriver_HeaderFile
#define _MDataStd_TreeNodeStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_TreeNodeStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
...
//!          is available: 0. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_TreeNodeStorageDriver)
