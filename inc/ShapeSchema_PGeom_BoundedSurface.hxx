...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BoundedSurface,Storage_CallBack)

class ShapeSchema_PGeom_BoundedSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BoundedSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BoundedSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BoundedSurface)
};
#endif
