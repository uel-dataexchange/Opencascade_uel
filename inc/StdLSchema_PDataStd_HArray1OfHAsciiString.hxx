...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_HArray1OfHAsciiString,Storage_CallBack)

class StdLSchema_PDataStd_HArray1OfHAsciiString : public Storage_CallBack {
public:
  StdLSchema_PDataStd_HArray1OfHAsciiString() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_HArray1OfHAsciiString)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_HArray1OfHAsciiString)
};
#endif
