...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Color,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Color : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Color() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Color)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Color)
};
#endif
