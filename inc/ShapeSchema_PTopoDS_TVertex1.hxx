...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TVertex1,Storage_CallBack)

class ShapeSchema_PTopoDS_TVertex1 : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TVertex1() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TVertex1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TVertex1)
};
#endif
