...
#ifndef _IGESSolid_ToolSolidOfRevolution_HeaderFile
#define _IGESSolid_ToolSolidOfRevolution_HeaderFile
...
//! Tool to work on a SolidOfRevolution. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_SolidOfRevolution)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a SolidOfRevolution <ent>, from <br>
