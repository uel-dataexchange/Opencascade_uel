...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_Volume,Storage_CallBack)

class XCAFSchema_PXCAFDoc_Volume : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_Volume() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_Volume)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_Volume)
};
#endif
