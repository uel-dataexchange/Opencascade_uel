...
#endif
#ifndef _Handle_PTopoDS_TShell1_HeaderFile
...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TShell1,Storage_CallBack)

class ShapeSchema_PTopoDS_TShell1 : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TShell1() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TShell1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TShell1)
};
#endif
