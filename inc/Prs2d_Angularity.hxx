...
#ifndef _Prs2d_Angularity_HeaderFile
#define _Prs2d_Angularity_HeaderFile
...
#endif
#ifndef _Handle_Prs2d_Angularity_HeaderFile
...
//!          reference point is <aXPosition>, <aYPosition> <br>
  Standard_EXPORT   Prs2d_Angularity(const Handle(Graphic2d_GraphicObject)& aGO,const Standard_Real aX,const Standard_Real aY,const Standard_Real aLength = 3.0,const Standard_Real anAngle = 0.0);
  ...
  DEFINE_STANDARD_RTTI(Prs2d_Angularity)

protected:

  //! Draws the Angularity <me>. <br>
