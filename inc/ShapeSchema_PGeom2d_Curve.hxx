...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_Curve,Storage_CallBack)

class ShapeSchema_PGeom2d_Curve : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_Curve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_Curve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_Curve)
};
#endif
