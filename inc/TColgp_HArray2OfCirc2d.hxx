...
public:
  ...
  Standard_EXPORT   TColgp_HArray2OfCirc2d(const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2);
  
  Standard_EXPORT   TColgp_HArray2OfCirc2d(const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2,const gp_Circ2d& V);
  ...
  Standard_EXPORT    const gp_Circ2d& Value(const Standard_Integer Row,const Standard_Integer Col) const;
  
  Standard_EXPORT     gp_Circ2d& ChangeValue(const Standard_Integer Row,const Standard_Integer Col) ;
