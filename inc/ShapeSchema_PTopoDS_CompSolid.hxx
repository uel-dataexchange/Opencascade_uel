...
#endif
#ifndef _Handle_PTopoDS_CompSolid_HeaderFile
...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_CompSolid,Storage_CallBack)

class ShapeSchema_PTopoDS_CompSolid : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_CompSolid() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_CompSolid)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_CompSolid)
};
#endif
