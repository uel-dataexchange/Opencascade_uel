...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_BooleanList,Storage_CallBack)

class StdLSchema_PDataStd_BooleanList : public Storage_CallBack {
public:
  StdLSchema_PDataStd_BooleanList() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_BooleanList)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_BooleanList)
};
#endif
