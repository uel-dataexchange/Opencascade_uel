...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BSplineCurve,Storage_CallBack)

class ShapeSchema_PGeom_BSplineCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BSplineCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BSplineCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BSplineCurve)
};
#endif
