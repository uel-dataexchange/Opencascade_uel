...
#ifndef _WNT_TextManager_HeaderFile
#define _WNT_TextManager_HeaderFile
...
class WNT_TextManager : public MFT_TextManager {

public:

  
  Standard_EXPORT   WNT_TextManager(const Standard_Real aPixelToUnit);
...
//!          drawing. <br>
  ...
  Standard_EXPORT     void SetDrawAttribs(const Standard_Address aDrawData) ;
...
friend class WNT_WDriver;
  ...
  DEFINE_STANDARD_RTTI(WNT_TextManager)
...
Standard_Integer myDevContext;
Standard_Boolean myWin95;
Standard_Integer myDevWidth;
Standard_Integer myDevHeight;
Standard_Integer myUWidth;
Standard_Integer myMonoBuf;
