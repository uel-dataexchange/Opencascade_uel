...
#define _Handle_GeomPlate_SequenceNodeOfSequenceOfCurveConstraint_HeaderFile
...
DEFINE_STANDARD_HANDLE(GeomPlate_SequenceNodeOfSequenceOfCurveConstraint,TCollection_SeqNode)
