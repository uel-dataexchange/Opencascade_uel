...
public:
  ...
  //! in the View table
  Standard_EXPORT void GetViewLabels (TDF_LabelSequence1& theLabels) const;

  //! Sets a link with GUID
  Standard_EXPORT void SetView(const TDF_LabelSequence1& theShapes,
                               const TDF_LabelSequence1& theGDTs,
                               const TDF_LabelSequence1& theClippingPlanes,
                               const TDF_LabelSequence1& theNotes,
                               const TDF_LabelSequence1& theAnnotations,
  ...
  Standard_EXPORT void SetClippingPlanes(const TDF_LabelSequence1& theClippingPlaneLabels,
                                         const TDF_Label& theViewL) const;
  ...
  Standard_EXPORT Standard_Boolean GetViewLabelsForShape (const TDF_Label& theShapeL, TDF_LabelSequence1& theViews) const;

  //! Returns all View labels defined for label GDTL
  Standard_EXPORT Standard_Boolean GetViewLabelsForGDT (const TDF_Label& theGDTL, TDF_LabelSequence1& theViews) const;

  //! Returns all View labels defined for label ClippingPlaneL
  Standard_EXPORT Standard_Boolean GetViewLabelsForClippingPlane(const TDF_Label& theClippingPlaneL, TDF_LabelSequence1& theViews) const;

  //! Returns all View labels defined for label NoteL
  Standard_EXPORT Standard_Boolean GetViewLabelsForNote(const TDF_Label& theNoteL, TDF_LabelSequence1& theViews) const;

  //! Returns all View labels defined for label AnnotationL
  Standard_EXPORT Standard_Boolean GetViewLabelsForAnnotation(const TDF_Label& theAnnotationL, TDF_LabelSequence1& theViews) const;
  ...
  Standard_EXPORT Standard_Boolean GetRefShapeLabel (const TDF_Label& theViewL, TDF_LabelSequence1& theShapeLabels) const;
  
  //! Returns GDT labels defined for label theViewL
  //! Returns False if the theViewL is not in View table
  Standard_EXPORT Standard_Boolean GetRefGDTLabel (const TDF_Label& theViewL, TDF_LabelSequence1& theGDTLabels) const;

  //! Returns ClippingPlane labels defined for label theViewL
  //! Returns False if the theViewL is not in View table
  Standard_EXPORT Standard_Boolean GetRefClippingPlaneLabel(const TDF_Label& theViewL, TDF_LabelSequence1& theClippingPlaneLabels) const;

  //! Returns Notes labels defined for label theViewL
  //! Returns False if the theViewL is not in View table
  Standard_EXPORT Standard_Boolean GetRefNoteLabel(const TDF_Label& theViewL, TDF_LabelSequence1& theNoteLabels) const;

  //! Returns Annotation labels defined for label theViewL
  //! Returns False if the theViewL is not in View table
  Standard_EXPORT Standard_Boolean GetRefAnnotationLabel(const TDF_Label& theViewL, TDF_LabelSequence1& theAnnotationLabels) const;
