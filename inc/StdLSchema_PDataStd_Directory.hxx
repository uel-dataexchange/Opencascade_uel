...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Directory,Storage_CallBack)

class StdLSchema_PDataStd_Directory : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Directory() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Directory)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Directory)
};
#endif
