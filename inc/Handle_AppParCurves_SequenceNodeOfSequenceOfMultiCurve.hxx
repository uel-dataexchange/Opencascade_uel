...
#define _Handle_AppParCurves_SequenceNodeOfSequenceOfMultiCurve_HeaderFile
...
DEFINE_STANDARD_HANDLE(AppParCurves_SequenceNodeOfSequenceOfMultiCurve,TCollection_SeqNode)
