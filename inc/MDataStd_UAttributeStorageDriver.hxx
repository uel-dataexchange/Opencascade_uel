...
#ifndef _MDataStd_UAttributeStorageDriver_HeaderFile
#define _MDataStd_UAttributeStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_UAttributeStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: UAttribute from TDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_UAttributeStorageDriver)
