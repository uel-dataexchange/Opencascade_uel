...
#define _PColPGeom2d_FieldOfHArray1OfBezierCurve_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColPGeom2d_FieldOfHArray1OfBezierCurve);
...
public:
  ...
  Standard_EXPORT   PColPGeom2d_FieldOfHArray1OfBezierCurve(const Standard_Integer Size);
  
  Standard_EXPORT   PColPGeom2d_FieldOfHArray1OfBezierCurve(const PColPGeom2d_FieldOfHArray1OfBezierCurve& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColPGeom2d_FieldOfHArray1OfBezierCurve& Other) ;
