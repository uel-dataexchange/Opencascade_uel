...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_BSplineSurface,Storage_CallBack)

class ShapeSchema_PGeom_BSplineSurface : public Storage_CallBack {
public:
  ShapeSchema_PGeom_BSplineSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_BSplineSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_BSplineSurface)
};
#endif
