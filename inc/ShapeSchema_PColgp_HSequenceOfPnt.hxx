...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColgp_HSequenceOfPnt,Storage_CallBack)

class ShapeSchema_PColgp_HSequenceOfPnt : public Storage_CallBack {
public:
  ShapeSchema_PColgp_HSequenceOfPnt() {}
  Standard_EXPORT static void SAdd(const Handle(PColgp_HSequenceOfPnt)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColgp_HSequenceOfPnt)
};
#endif
