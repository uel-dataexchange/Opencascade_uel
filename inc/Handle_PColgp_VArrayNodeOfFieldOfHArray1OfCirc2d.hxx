...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray1OfCirc2d,PStandard_ArrayNode)
