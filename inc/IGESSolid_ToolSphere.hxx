...
#ifndef _IGESSolid_ToolSphere_HeaderFile
#define _IGESSolid_ToolSphere_HeaderFile
...
//! Tool to work on a Sphere. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_Sphere)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a Sphere <ent>, from <br>
