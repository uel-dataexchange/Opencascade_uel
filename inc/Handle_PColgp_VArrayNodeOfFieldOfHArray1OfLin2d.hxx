...
#define _Handle_PColgp_VArrayNodeOfFieldOfHArray1OfLin2d_HeaderFile
...
DEFINE_STANDARD_PHANDLE(PColgp_VArrayNodeOfFieldOfHArray1OfLin2d,PStandard_ArrayNode)
