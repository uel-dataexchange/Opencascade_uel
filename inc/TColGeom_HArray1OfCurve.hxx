...
public:
  ...
  Standard_EXPORT   TColGeom_HArray1OfCurve(const Standard_Integer Low,const Standard_Integer Up);
  
  Standard_EXPORT   TColGeom_HArray1OfCurve(const Standard_Integer Low,const Standard_Integer Up,const Handle(Geom_Curve)& V);
...
#define ItemHArray1 Handle_Geom_Curve
