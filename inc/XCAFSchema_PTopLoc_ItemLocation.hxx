...
DEFINE_STANDARD_HANDLE(XCAFSchema_PTopLoc_ItemLocation,Storage_CallBack)

class XCAFSchema_PTopLoc_ItemLocation : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PTopLoc_ItemLocation)
};
#endif
