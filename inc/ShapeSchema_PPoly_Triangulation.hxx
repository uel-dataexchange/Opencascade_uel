...
DEFINE_STANDARD_HANDLE(ShapeSchema_PPoly_Triangulation,Storage_CallBack)

class ShapeSchema_PPoly_Triangulation : public Storage_CallBack {
public:
  ShapeSchema_PPoly_Triangulation() {}
  Standard_EXPORT static void SAdd(const Handle(PPoly_Triangulation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PPoly_Triangulation)
};
#endif
