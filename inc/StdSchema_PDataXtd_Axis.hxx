...
#endif
#ifndef _Handle_PDataXtd_Axis_HeaderFile
...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Axis,Storage_CallBack)

class StdSchema_PDataXtd_Axis : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Axis() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Axis)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Axis)
};
#endif
