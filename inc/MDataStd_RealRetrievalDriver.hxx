...
#ifndef _MDataStd_RealRetrievalDriver_HeaderFile
#define _MDataStd_RealRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_RealRetrievalDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_RealRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Real from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_RealRetrievalDriver)
