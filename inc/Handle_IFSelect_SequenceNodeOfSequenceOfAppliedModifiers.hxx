...
#define _Handle_IFSelect_SequenceNodeOfSequenceOfAppliedModifiers_HeaderFile
...
DEFINE_STANDARD_HANDLE(IFSelect_SequenceNodeOfSequenceOfAppliedModifiers,TCollection_SeqNode)
