...
#define _Handle_TColGeom_SequenceNodeOfSequenceOfBoundedSurface_HeaderFile
...
DEFINE_STANDARD_HANDLE(TColGeom_SequenceNodeOfSequenceOfBoundedSurface,TCollection_SeqNode)
