...
#include <TColStd_ListOfAsciiString1.hxx>
...
public:
  ...
  Standard_EXPORT XCAFDoc_AssemblyItemId(const TColStd_ListOfAsciiString1& thePath);
  ...
  //! string is a label entry.
  //! \param [in] thePath - list of label entries.
  Standard_EXPORT void Init(const TColStd_ListOfAsciiString1& thePath);
  ...
  Standard_EXPORT const TColStd_ListOfAsciiString1& GetPath() const;
...
private:
  ...
  TColStd_ListOfAsciiString1 myPath; ///< List of label entries
