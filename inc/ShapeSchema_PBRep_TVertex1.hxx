...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_TVertex1,Storage_CallBack)

class ShapeSchema_PBRep_TVertex1 : public Storage_CallBack {
public:
  ShapeSchema_PBRep_TVertex1() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_TVertex1)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_TVertex1)
};
#endif
