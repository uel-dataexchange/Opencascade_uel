...
#define _BOPTools_CArray1OfEEInterference_HeaderFile
...
~BOPTools_CArray1OfEEInterference()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_EEInterference& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_EEInterference& Value(const Standard_Integer Index) const;
   const BOPTools_EEInterference& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_EEInterference& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CArray1OfEEInterference(const BOPTools_CArray1OfEEInterference& AnArray);
  
  Standard_EXPORT     BOPTools_CArray1OfEEInterference& Assign(const BOPTools_CArray1OfEEInterference& Other) ;
    BOPTools_CArray1OfEEInterference& operator =(const BOPTools_CArray1OfEEInterference& Other) 
{
  return Assign(Other);
}
