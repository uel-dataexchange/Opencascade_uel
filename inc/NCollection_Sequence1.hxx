...
#ifndef NCollection_Sequence1_HeaderFile
#define NCollection_Sequence1_HeaderFile
...
class NCollection_Sequence1 : public NCollection_BaseSequence1
{
public:
...
public:
  ...
  class Node : public NCollection_SeqNode1
  {
  public:
    //! Constructor
 ...
 public:
  ...
  class Iterator : public NCollection_BaseSequence1::Iterator
  {
  public:
    //! Empty constructor - for later Init
    Iterator  (void) {}
    //! Constructor with initialisation
    Iterator  (const NCollection_Sequence1& theSeq,
               const Standard_Boolean      isStart = Standard_True)
      : NCollection_BaseSequence1::Iterator (theSeq, isStart) {}
    //! Check end
 ...
 public:
  ...
  //! Empty constructor.
  NCollection_Sequence1() : NCollection_BaseSequence1(Handle(NCollection_BaseAllocator)()) {}

  //! Constructor
  explicit NCollection_Sequence1 (const Handle(NCollection_BaseAllocator)& theAllocator) : NCollection_BaseSequence1(theAllocator) {}

  //! Copy constructor
  NCollection_Sequence1 (const NCollection_Sequence1& theOther) :
    NCollection_BaseSequence1(theOther.myAllocator)
  {
    Assign (theOther);
  }
  ...
  static void delNode (NCollection_SeqNode1 * theNode, 
  ...
  NCollection_Sequence1& Assign (const NCollection_Sequence1& theOther)
  { 
    if (this == &theOther) 
      return *this;
    Clear ();
  ...
  NCollection_Sequence1& operator= (const NCollection_Sequence1& theOther)
  {
  ...
  void Append (NCollection_Sequence1& theSeq)
  {
  ...
  void Prepend (NCollection_Sequence1& theSeq)
  {
    if (myFirstItem == theSeq.myFirstItem) Assign (theSeq);
    PPrepend (theSeq);
  }
  ...
  void InsertAfter (const Standard_Integer  theIndex, 
                    const TheItemType&      theItem)
  {
    Standard_OutOfRange_Raise_if (theIndex < 0 || theIndex > mySize, "NCollection_Sequence1::InsertAfter");
    PInsertAfter (theIndex, new (this->myAllocator) Node (theItem));
  }

  //! Split in two sequences
  void Split (const Standard_Integer theIndex, NCollection_Sequence1& theSeq)
  {
  ...
  {
    Standard_NoSuchObject_Raise_if (mySize == 0, "NCollection_Sequence1::First");
  ...
  {
    Standard_NoSuchObject_Raise_if (mySize == 0, "NCollection_Sequence1::ChangeFirst");
  ...
  {
    Standard_NoSuchObject_Raise_if (mySize == 0, "NCollection_Sequence1::Last");
  ...
  {
    Standard_NoSuchObject_Raise_if (mySize == 0, "NCollection_Sequence1::ChangeLast");
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex <= 0 || theIndex > mySize, "NCollection_Sequence1::Value");

    NCollection_Sequence1 * const aLocalTHIS = (NCollection_Sequence1 *) this;
  ...
  {
    Standard_OutOfRange_Raise_if (theIndex <= 0 || theIndex > mySize, "NCollection_Sequence1::ChangeValue");
  ...
  virtual ~NCollection_Sequence1 (void)
  { Clear(); }
