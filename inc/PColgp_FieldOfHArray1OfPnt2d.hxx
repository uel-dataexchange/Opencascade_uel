...
#define _PColgp_FieldOfHArray1OfPnt2d_HeaderFile
...
Standard_EXPORT const Handle(Standard_Type)& STANDARD_TYPE(PColgp_FieldOfHArray1OfPnt2d);
...
public:
  ...
  Standard_EXPORT   PColgp_FieldOfHArray1OfPnt2d(const Standard_Integer Size);
  
  Standard_EXPORT   PColgp_FieldOfHArray1OfPnt2d(const PColgp_FieldOfHArray1OfPnt2d& Varray);
  
  Standard_EXPORT     void Resize(const Standard_Integer Size) ;
  
  Standard_EXPORT     void Assign(const PColgp_FieldOfHArray1OfPnt2d& Other) ;
