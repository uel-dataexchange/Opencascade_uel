...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TFace,Storage_CallBack)

class ShapeSchema_PTopoDS_TFace : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TFace() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TFace)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TFace)
};
#endif
