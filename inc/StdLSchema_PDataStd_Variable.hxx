...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_Variable,Storage_CallBack)

class StdLSchema_PDataStd_Variable : public Storage_CallBack {
public:
  StdLSchema_PDataStd_Variable() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_Variable)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_Variable)
};
#endif
