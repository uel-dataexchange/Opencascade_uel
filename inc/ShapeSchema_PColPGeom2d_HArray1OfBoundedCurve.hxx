...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom2d_HArray1OfBoundedCurve,Storage_CallBack)

class ShapeSchema_PColPGeom2d_HArray1OfBoundedCurve : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom2d_HArray1OfBoundedCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom2d_HArray1OfBoundedCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom2d_HArray1OfBoundedCurve)
};
#endif
