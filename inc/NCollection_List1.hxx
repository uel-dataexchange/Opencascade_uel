...
#ifndef NCollection_List1_HeaderFile
#define NCollection_List1_HeaderFile

#include <NCollection_TListIterator1.hxx>
...
class NCollection_List1 : public NCollection_BaseList1
{
public:
...
public:
  typedef NCollection_TListNode1<TheItemType>     ListNode;
  typedef NCollection_TListIterator1<TheItemType> Iterator;
 ...
 public:
  ...
  //! Empty constructor.
  NCollection_List1() : NCollection_BaseList1(Handle(NCollection_BaseAllocator)()) {}

  //! Constructor
  explicit NCollection_List1(const Handle(NCollection_BaseAllocator)& theAllocator) : NCollection_BaseList1(theAllocator) {}

  //! Copy constructor
  NCollection_List1 (const NCollection_List1& theOther) :
    NCollection_BaseList1(theOther.myAllocator)
  {
    Assign (theOther);
  }
  ...
  NCollection_List1& Assign (const NCollection_List1& theOther)
  {
    if (this != &theOther) {
      Clear();
  ...
  NCollection_List1& operator= (const NCollection_List1& theOther)
  {
  ...
  {
    Standard_NoSuchObject_Raise_if (IsEmpty(), "NCollection_List1::First");
  ...
  { 
    Standard_NoSuchObject_Raise_if (IsEmpty(), "NCollection_List1::Last");
  ...
  void Append (NCollection_List1& theOther)
  { 
  ...
  void Prepend (NCollection_List1& theOther)
  { 
    if (this == &theOther || theOther.Extent()<1) 
      return;
    if (this->myAllocator == theOther.myAllocator)
  ...
  //! InsertBefore
  void InsertBefore (NCollection_List1& theOther,
                     Iterator& theIter) 
  {
    if (this == &theOther) 
      return;
  ...
  //! InsertAfter
  void InsertAfter (NCollection_List1& theOther,
                    Iterator& theIter) 
  {
    if (!theIter.More())
    {
    ...
    {
      // No - this list has different memory scope
      Standard_NoSuchObject_Raise_if (!theIter.More(), "NCollection_List1::InsertAfter");
  ...
  virtual ~NCollection_List1 (void)
  { Clear(); }
 ...
 private:
  ...
  void appendList(const NCollection_ListNode1 * pCur) {
    while (pCur) {
      NCollection_ListNode1 * pNew =
  ...
  void prependList(const NCollection_ListNode1 * pCur, Iterator& theIter) {
    while (pCur) {
      NCollection_ListNode1 * pNew =
        new (this->myAllocator) ListNode (((const ListNode *)(pCur))->Value());
      PInsertBefore(pNew, theIter);
