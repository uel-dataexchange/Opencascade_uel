...
#define _Handle_Aspect_SequenceNodeOfSequenceOfColorMapEntry_HeaderFile
...
DEFINE_STANDARD_HANDLE(Aspect_SequenceNodeOfSequenceOfColorMapEntry,TCollection_SeqNode)
