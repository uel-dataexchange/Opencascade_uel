...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_PolygonOnClosedTriangulation,Storage_CallBack)

class ShapeSchema_PBRep_PolygonOnClosedTriangulation : public Storage_CallBack {
public:
  ShapeSchema_PBRep_PolygonOnClosedTriangulation() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_PolygonOnClosedTriangulation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_PolygonOnClosedTriangulation)
};
#endif
