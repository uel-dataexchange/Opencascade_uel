...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom2d_BoundedCurve,Storage_CallBack)

class ShapeSchema_PGeom2d_BoundedCurve : public Storage_CallBack {
public:
  ShapeSchema_PGeom2d_BoundedCurve() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom2d_BoundedCurve)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom2d_BoundedCurve)
};
#endif
