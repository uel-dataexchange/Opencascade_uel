...
#ifndef _MDataXtd_PointRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataXtd_PointRetrievalDriver_HeaderFile
#include <Handle_MDataXtd_PointRetrievalDriver.hxx>
#endif
...
public:
  ...
  Standard_EXPORT   MDataXtd_PointRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: Point from PDataXtd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataXtd_PointRetrievalDriver)
