...
#define _TColGeom_Array2OfBoundedSurface_HeaderFile
...
public:
  ...
  Standard_EXPORT   TColGeom_Array2OfBoundedSurface(const Handle(Geom_BoundedSurface)& Item,const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2);
...
~TColGeom_Array2OfBoundedSurface()
{
  ...
  Standard_EXPORT    const TColGeom_Array2OfBoundedSurface& Assign(const TColGeom_Array2OfBoundedSurface& Other) ;
...
private:
  ...
  Standard_EXPORT   TColGeom_Array2OfBoundedSurface(const TColGeom_Array2OfBoundedSurface& AnArray);
