...
#ifndef _IGESSolid_ToolRightAngularWedge_HeaderFile
#define _IGESSolid_ToolRightAngularWedge_HeaderFile
...
//! Tool to work on a RightAngularWedge. Called by various Modules <br>
...
//!           <IR> detains parameter types and values <br>
  Standard_EXPORT     void ReadOwnParams(const Handle(IGESSolid_RightAngularWedge)& ent,const Handle(IGESData_IGESReaderData)& IR,IGESData_ParamReader& PR) const;
  ...
  //! Lists the Entities shared by a RightAngularWedge <ent>, from <br>
