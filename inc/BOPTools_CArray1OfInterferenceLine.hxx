...
#define _BOPTools_CArray1OfInterferenceLine_HeaderFile
...
~BOPTools_CArray1OfInterferenceLine()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_InterferenceLine& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_InterferenceLine& Value(const Standard_Integer Index) const;
   const BOPTools_InterferenceLine& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_InterferenceLine& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CArray1OfInterferenceLine(const BOPTools_CArray1OfInterferenceLine& AnArray);
  
  Standard_EXPORT     BOPTools_CArray1OfInterferenceLine& Assign(const BOPTools_CArray1OfInterferenceLine& Other) ;
    BOPTools_CArray1OfInterferenceLine& operator =(const BOPTools_CArray1OfInterferenceLine& Other) 
{
  return Assign(Other);
}
