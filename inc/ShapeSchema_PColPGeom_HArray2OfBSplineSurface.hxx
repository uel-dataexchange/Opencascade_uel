...
DEFINE_STANDARD_HANDLE(ShapeSchema_PColPGeom_HArray2OfBSplineSurface,Storage_CallBack)

class ShapeSchema_PColPGeom_HArray2OfBSplineSurface : public Storage_CallBack {
public:
  ShapeSchema_PColPGeom_HArray2OfBSplineSurface() {}
  Standard_EXPORT static void SAdd(const Handle(PColPGeom_HArray2OfBSplineSurface)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PColPGeom_HArray2OfBSplineSurface)
};
#endif
