...
DEFINE_STANDARD_HANDLE(StdLSchema_PDataStd_AsciiString,Storage_CallBack)

class StdLSchema_PDataStd_AsciiString : public Storage_CallBack {
public:
  StdLSchema_PDataStd_AsciiString() {}
  Standard_EXPORT static void SAdd(const Handle(PDataStd_AsciiString)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDataStd_AsciiString)
};
#endif
