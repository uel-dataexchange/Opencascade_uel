...
#ifndef _Prs2d_Circularity_HeaderFile
#define _Prs2d_Circularity_HeaderFile
...
#endif
#ifndef _Handle_Prs2d_Circularity_HeaderFile
...
//!          reference point is <aXPosition>, <aYPosition> <br>
  Standard_EXPORT   Prs2d_Circularity(const Handle(Graphic2d_GraphicObject)& aGO,const Standard_Real aX,const Standard_Real aY,const Standard_Real aLength = 3.0,const Standard_Real anAngle = 0.0);
  ...
  DEFINE_STANDARD_RTTI(Prs2d_Circularity)

protected:

  //! Draws the Circularity <me>. <br>
