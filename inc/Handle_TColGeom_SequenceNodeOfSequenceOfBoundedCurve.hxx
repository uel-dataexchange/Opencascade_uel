...
#define _Handle_TColGeom_SequenceNodeOfSequenceOfBoundedCurve_HeaderFile
...
DEFINE_STANDARD_HANDLE(TColGeom_SequenceNodeOfSequenceOfBoundedCurve,TCollection_SeqNode)
