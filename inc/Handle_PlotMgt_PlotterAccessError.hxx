...
#define _Handle_PlotMgt_PlotterAccessError_HeaderFile
...
class PlotMgt_PlotterAccessError;

DEFINE_STANDARD_HANDLE(PlotMgt_PlotterAccessError,Standard_OutOfRange)
