...
#define _ExprIntrp_StackIteratorOfStackOfGeneralExpression_HeaderFile
...
public:
  ...
  Standard_EXPORT   ExprIntrp_StackIteratorOfStackOfGeneralExpression(const ExprIntrp_StackOfGeneralExpression& S);
  
  Standard_EXPORT     void Initialize(const ExprIntrp_StackOfGeneralExpression& S) ;
  
        Standard_Boolean More() const;
  
  Standard_EXPORT     void Next() ;
  
  Standard_EXPORT    const Handle_Expr_GeneralExpression& Value() const;
