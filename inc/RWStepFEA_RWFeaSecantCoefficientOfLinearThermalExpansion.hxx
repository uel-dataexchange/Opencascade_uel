...
//! Read & Write tool for FeaSecantCoefficientOfLinearThermalExpansion <br>
...
public:
  ...
  //! Reads FeaSecantCoefficientOfLinearThermalExpansion <br>
  ...
  //! Writes FeaSecantCoefficientOfLinearThermalExpansion <br>
