...
#define _BOPTools_CArray1OfVSInterference_HeaderFile
...
~BOPTools_CArray1OfVSInterference()
{
  ...
  Standard_EXPORT     Standard_Integer Append(const BOPTools_VSInterference& Value) ;
  
  Standard_EXPORT     void Remove(const Standard_Integer Index) ;
  
  Standard_EXPORT    const BOPTools_VSInterference& Value(const Standard_Integer Index) const;
   const BOPTools_VSInterference& operator ()(const Standard_Integer Index) const
{
  return Value(Index);
}
  
  Standard_EXPORT     BOPTools_VSInterference& ChangeValue(const Standard_Integer Index) ;
...
private:
  ...
  Standard_EXPORT   BOPTools_CArray1OfVSInterference(const BOPTools_CArray1OfVSInterference& AnArray);
  
  Standard_EXPORT     BOPTools_CArray1OfVSInterference& Assign(const BOPTools_CArray1OfVSInterference& Other) ;
    BOPTools_CArray1OfVSInterference& operator =(const BOPTools_CArray1OfVSInterference& Other) 
{
  return Assign(Other);
}
