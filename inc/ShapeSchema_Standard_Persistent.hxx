...
DEFINE_STANDARD_HANDLE(ShapeSchema_Standard_Persistent,Storage_CallBack)

class ShapeSchema_Standard_Persistent : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_Standard_Persistent)
};
#endif
