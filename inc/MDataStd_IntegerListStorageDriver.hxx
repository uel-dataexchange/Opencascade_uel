...
#ifndef _MDataStd_IntegerListStorageDriver_HeaderFile
#define _MDataStd_IntegerListStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_IntegerListStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  ...
  DEFINE_STANDARD_RTTI(MDataStd_IntegerListStorageDriver)
