...
DEFINE_STANDARD_HANDLE(XCAFSchema_PXCAFDoc_SeqNodeOfGraphNodeSequence,Storage_CallBack)

class XCAFSchema_PXCAFDoc_SeqNodeOfGraphNodeSequence : public Storage_CallBack {
public:
  XCAFSchema_PXCAFDoc_SeqNodeOfGraphNodeSequence() {}
  Standard_EXPORT static void SAdd(const Handle(PXCAFDoc_SeqNodeOfGraphNodeSequence)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(XCAFSchema_PXCAFDoc_SeqNodeOfGraphNodeSequence)
};
#endif
