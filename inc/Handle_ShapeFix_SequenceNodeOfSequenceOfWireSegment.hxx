...
#define _Handle_ShapeFix_SequenceNodeOfSequenceOfWireSegment_HeaderFile
...
DEFINE_STANDARD_HANDLE(ShapeFix_SequenceNodeOfSequenceOfWireSegment,TCollection_SeqNode)
