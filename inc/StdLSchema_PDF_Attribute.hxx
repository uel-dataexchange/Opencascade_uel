...
DEFINE_STANDARD_HANDLE(StdLSchema_PDF_Attribute,Storage_CallBack)

class StdLSchema_PDF_Attribute : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDF_Attribute)
};
#endif
