...
DEFINE_STANDARD_HANDLE(ShapeSchema_PPoly_PolygonOnTriangulation,Storage_CallBack)

class ShapeSchema_PPoly_PolygonOnTriangulation : public Storage_CallBack {
public:
  ShapeSchema_PPoly_PolygonOnTriangulation() {}
  Standard_EXPORT static void SAdd(const Handle(PPoly_PolygonOnTriangulation)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PPoly_PolygonOnTriangulation)
};
#endif
