...
DEFINE_STANDARD_HANDLE(ShapeSchema_PTopoDS_TCompound,Storage_CallBack)

class ShapeSchema_PTopoDS_TCompound : public Storage_CallBack {
public:
  ShapeSchema_PTopoDS_TCompound() {}
  Standard_EXPORT static void SAdd(const Handle(PTopoDS_TCompound)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PTopoDS_TCompound)
};
#endif
