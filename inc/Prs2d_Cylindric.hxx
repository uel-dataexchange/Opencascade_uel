...
#define _Prs2d_Cylindric_HeaderFile
...
#endif
#ifndef _Handle_Prs2d_Cylindric_HeaderFile
...
public:
  ...
  //! Creates a tolerance Cylindric with the center at <aX>, <aY>; <br>
//!          length of this is <aLength>; <br>
//!          reference point is <aXPosition>, <aYPosition> <br>
  Standard_EXPORT   Prs2d_Cylindric(const Handle(Graphic2d_GraphicObject)& aGO,const Standard_Real aX,const Standard_Real aY,const Standard_Real aLength = 3.0,const Standard_Real anAngle = 0.0);
  ...
  DEFINE_STANDARD_RTTI(Prs2d_Cylindric)

protected:

  //! Draws the Cylindric <me>. <br>
