...
DEFINE_STANDARD_HANDLE(StdSchema_PDataXtd_Position,Storage_CallBack)

class StdSchema_PDataXtd_Position : public Storage_CallBack {
public:
  StdSchema_PDataXtd_Position() {}
  Standard_EXPORT static void SAdd(const Handle(PDataXtd_Position)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataXtd_Position)
};
#endif
