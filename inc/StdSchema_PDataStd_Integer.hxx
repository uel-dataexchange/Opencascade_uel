...
DEFINE_STANDARD_HANDLE(StdSchema_PDataStd_Integer,Storage_CallBack)

class StdSchema_PDataStd_Integer : public Storage_CallBack {
public:
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PDataStd_Integer)
};
#endif
