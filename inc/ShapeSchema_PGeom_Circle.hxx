...
DEFINE_STANDARD_HANDLE(ShapeSchema_PGeom_Circle,Storage_CallBack)

class ShapeSchema_PGeom_Circle : public Storage_CallBack {
public:
  ShapeSchema_PGeom_Circle() {}
  Standard_EXPORT static void SAdd(const Handle(PGeom_Circle)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PGeom_Circle)
};
#endif
