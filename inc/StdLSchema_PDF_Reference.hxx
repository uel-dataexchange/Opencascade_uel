...
DEFINE_STANDARD_HANDLE(StdLSchema_PDF_Reference,Storage_CallBack)

class StdLSchema_PDF_Reference : public Storage_CallBack {
public:
  StdLSchema_PDF_Reference() {}
  Standard_EXPORT static void SAdd(const Handle(PDF_Reference)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdLSchema_PDF_Reference)
};
#endif
