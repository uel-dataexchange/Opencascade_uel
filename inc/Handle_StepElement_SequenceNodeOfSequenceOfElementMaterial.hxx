...
#define _Handle_StepElement_SequenceNodeOfSequenceOfElementMaterial_HeaderFile
...
DEFINE_STANDARD_HANDLE(StepElement_SequenceNodeOfSequenceOfElementMaterial,TCollection_SeqNode)
