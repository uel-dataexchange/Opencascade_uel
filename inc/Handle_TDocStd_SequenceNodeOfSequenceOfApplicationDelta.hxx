...
#define _Handle_TDocStd_SequenceNodeOfSequenceOfApplicationDelta_HeaderFile
...
DEFINE_STANDARD_HANDLE(TDocStd_SequenceNodeOfSequenceOfApplicationDelta,TCollection_SeqNode)
