...
#ifndef _MDataStd_IntPackedMapRetrievalDriver_HeaderFile
#define _MDataStd_IntPackedMapRetrievalDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_IntPackedMapRetrievalDriver_HeaderFile
...
//! Retrieval driver of IntPackedMap attribute <br>
class MDataStd_IntPackedMapRetrievalDriver : public MDF_ARDriver {

public:

  
  Standard_EXPORT   MDataStd_IntPackedMapRetrievalDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: IntPackedMap from PDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_IntPackedMapRetrievalDriver)
