...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_TVertex,Storage_CallBack)

class ShapeSchema_PBRep_TVertex : public Storage_CallBack {
public:
  ShapeSchema_PBRep_TVertex() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_TVertex)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_TVertex)
};
#endif
