...
DEFINE_STANDARD_HANDLE(ShapeSchema_PBRep_CurveOn2Surfaces,Storage_CallBack)

class ShapeSchema_PBRep_CurveOn2Surfaces : public Storage_CallBack {
public:
  ShapeSchema_PBRep_CurveOn2Surfaces() {}
  Standard_EXPORT static void SAdd(const Handle(PBRep_CurveOn2Surfaces)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(ShapeSchema_PBRep_CurveOn2Surfaces)
};
#endif
