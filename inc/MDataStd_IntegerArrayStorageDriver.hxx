...
#ifndef _MDataStd_IntegerArrayStorageDriver_HeaderFile
#define _MDataStd_IntegerArrayStorageDriver_HeaderFile
...
#endif
#ifndef _Handle_MDataStd_IntegerArrayStorageDriver_HeaderFile
...
public:
  ...
  Standard_EXPORT   MDataStd_IntegerArrayStorageDriver(const Handle(CDM_MessageDriver)& theMessageDriver);
  //! Returns the version number from which the driver <br>
//!          is available: 0. <br>
  Standard_EXPORT     Standard_Integer VersionNumber() const;
  //! Returns the type: IntegerArray from TDataStd. <br>
  ...
  DEFINE_STANDARD_RTTI(MDataStd_IntegerArrayStorageDriver)
