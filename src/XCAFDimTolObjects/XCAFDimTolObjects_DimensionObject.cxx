...
IMPLEMENT_STANDARD_RTTIEXT_1(XCAFDimTolObjects_DimensionObject,Standard_Transient)
...
void XCAFDimTolObjects_DimensionObject::RemoveDescription(const Standard_Integer theNumber)
{
  if (theNumber < myDescriptions.Lower() || theNumber > myDescriptions.Upper())
    return;
  NCollection_Vector1<Handle(TCollection_HAsciiString)> aDescriptions;
  NCollection_Vector1<Handle(TCollection_HAsciiString)> aDescriptionNames;
