...
class GeomConvert_ApproxSurface_Evaluator : public AdvApp2Var_EvaluatorFunc2Var
{
public:
  GeomConvert_ApproxSurface_Evaluator (Handle(Adaptor3d_HSurface) a_fonct) :
    fonct(a_fonct) {}
...
//			   Standard_Integer * ErrorCode)
//                           // Error Code
void GeomConvert_ApproxSurface_Evaluator::Evaluate(Standard_Integer * Dimension,
  Standard_Real    * UStartEnd,
  Standard_Real    * VStartEnd,
  Standard_Integer * FavorIso,// Choice of constante, 1 for U, 2 for V
  Standard_Real    * ConstParam,// Value of constant parameter
