...
#include "StepToGeom_MakeBSplineCurve_1.pxx"
        ...
        if( !a2p.Axis2Placement3d()->HasRefDirection() ) {
          ...
          if(isPoint /*&& !MasterRep*/)
            ...
            if ( SC->SenseAgreement() )
              return new Geom_TrimmedCurve(theCurve, 0., 2.*PI, Standard_True);
            else
              return new Geom_TrimmedCurve(theCurve, 2.*PI, 0., Standard_False);
          }
        }
      }
    }
