...
#include <RWStepShape_RWTransitionalShapeRepresentation.ixx>
	 ...
	 const Handle(StepShape_TransitionalShapeRepresentation)& ent) const
{
	...
	if (!data->CheckNbParams(num,3,ach,"transitional_shape_representation")) return;
...
void RWStepShape_RWTransitionalShapeRepresentation::WriteStep
...
void RWStepShape_RWTransitionalShapeRepresentation::Share(const Handle(StepShape_TransitionalShapeRepresentation)& ent, Interface_EntityIterator& iter) const
{
