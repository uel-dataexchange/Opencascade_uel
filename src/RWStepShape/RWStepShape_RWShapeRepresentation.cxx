...
#include <RWStepShape_RWShapeRepresentation.ixx>
...
RWStepShape_RWShapeRepresentation::RWStepShape_RWShapeRepresentation () {}

void RWStepShape_RWShapeRepresentation::ReadStep
	(const Handle(StepData_StepReaderData)& data,
	 const Standard_Integer num,
	 Handle(Interface_Check)& ach,
	 const Handle(StepShape_ShapeRepresentation)& ent) const
{


	// --- Number of Parameter Control ---

	if (!data->CheckNbParams(num,3,ach,"shape_representation")) return;
...
void RWStepShape_RWShapeRepresentation::Share(const Handle(StepShape_ShapeRepresentation)& ent, Interface_EntityIterator& iter) const
{
