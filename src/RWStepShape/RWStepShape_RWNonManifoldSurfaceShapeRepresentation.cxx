// File:	RWStepShape_RWNonManifoldSurfaceShapeRepresentation.cxx
...
RWStepShape_RWNonManifoldSurfaceShapeRepresentation::RWStepShape_RWNonManifoldSurfaceShapeRepresentation ()
{
}
...
void RWStepShape_RWNonManifoldSurfaceShapeRepresentation::ReadStep (const Handle(StepData_StepReaderData)& data,
                                                                    const Standard_Integer num,
                                                                    Handle(Interface_Check)& ach,
                                                                    const Handle(StepShape_NonManifoldSurfaceShapeRepresentation) &ent) const
{
  // Check number of parameters
  if ( ! data->CheckNbParams(num,3,ach,"non_manifold_surface_shape_representation") ) return;
...
void RWStepShape_RWNonManifoldSurfaceShapeRepresentation::WriteStep (StepData_StepWriter& SW,
                                                                     const Handle(StepShape_NonManifoldSurfaceShapeRepresentation) &ent) const
{
...
void RWStepShape_RWNonManifoldSurfaceShapeRepresentation::Share (const Handle(StepShape_NonManifoldSurfaceShapeRepresentation) &ent,
