...

{
 ...
 /* for(Standard_Integer ii=1; ii <= VMults.Length(); ii++)
  {
	  cout << VMults.Value(ii) << endl;
  }*/
  // check
				  ...
				  const Standard_Real V2) 
{
  ...
  if(pindex1U <= 0 || pindex1V <= 0)
	  throw Standard_Failure("segment error");
...
Handle(TColStd_HArray1OfReal)& Geom_BSplineSurface::UFKnots ()
{
  return ufknots;
}
...
Handle(TColStd_HArray1OfReal)& Geom_BSplineSurface::VFKnots ()
{
  return vfknots;
}