...
#include <RWStepAP242_TessellatedSurfaceSet.hxx>
#include <StepAP242_ComplexTriangulatedSurfaceSet.hxx>
#include <RWStepAP242_ComplexTriangulatedSurfaceSet.hxx>
...
#include <RWStepAP242_TessellatedSolid.hxx>
...
static TCollection_AsciiString Reco_TessellatedSurfaceSet("TESSELLATED_SURFACE_SET");
static TCollection_AsciiString Reco_ComplexTessellatedSurfaceSet("COMPLEX_TRIANGULATED_SURFACE_SET");
...
static TCollection_AsciiString Reco_TessellatedFace("TESSELLATED_FACE");
...
//  typenums.Bind (Reco_FeaModelDefinition,574);
  ...
  // Add by UEL
  typenums.Bind(Reco_TessellatedItem, 750);
  typenums.Bind(Reco_RepositionedTessellatedItem, 751);
  typenums.Bind(Reco_TessellatedSurfaceSet, 753);
  typenums.Bind(Reco_ComplexTessellatedSurfaceSet, 754);
  typenums.Bind(Reco_RealRepresentationItem, 755);
  typenums.Bind(Reco_GeneralPropertyAssociation, 756);
  typenums.Bind(Reco_TessellatedFace, 757);
  typenums.Bind(Reco_ComplexTriangulatedFace, 758);
  typenums.Bind(Reco_TessellatedShell, 759);
  typenums.Bind(Reco_TessellatedSolid, 760);
  typenums.Bind(Reco_TessellatedShapeRepresentation, 761);
...
//  Sinon, il faudrait sortir des routines
    ...
    // Added by FMA
	  ...
	  if ((types(1).IsEqual(StepType(144))) &&
		  (types(2).IsEqual(StepType(751))) &&
		  (types(3).IsEqual(StepType(247))) &&
		  (types(4).IsEqual(StepType(709))) &&
		  (types(5).IsEqual(StepType(750)))) {
		  return 752;
	  }
    }
    else if (NbComp == 4) {
...
//  case 574: return Reco_FeaModelDefinition;
  ...
  case 718 : return Reco_CameraModelD3MultiClippingUnion;
	// Add by UEL
  case 750: return Reco_TessellatedItem;
  case 751: return Reco_RepositionedTessellatedItem;
  case 753: return Reco_TessellatedSurfaceSet;
  case 754: return Reco_ComplexTessellatedSurfaceSet;
  case 755: return Reco_RealRepresentationItem;
  case 756: return Reco_GeneralPropertyAssociation;
  case 757: return Reco_TessellatedFace;
  case 758: return Reco_ComplexTriangulatedFace;
  case 759: return Reco_TessellatedShell;
  case 760: return Reco_TessellatedSolid;
  case 761: return Reco_TessellatedShapeRepresentation;
                                                          ...
                                                          TColStd_SequenceOfAsciiString& types) const
{
  switch(CN)
	...
	case 752:
		types.Append(StepType(144));
		types.Append(StepType(751));
		types.Append(StepType(247));
		types.Append(StepType(709));
		types.Append(StepType(750));
		break;
    }
  return Standard_True;
}
...
//    break;
  ...
  case 706:
   ...
   break;
	 case 751:
	 {
		 DeclareAndCast(StepAP242_RepositionedTessellatedItem, anent, ent);
		 RWStepAP242_RepositionedTessellatedItem tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 752:
	 {
		 DeclareAndCast(StepAP242_RepositionedTessellatedItemAndRepresentationItemAndTessellatedGeometricSet, anent, ent);
		 RWStepAP242_RepositionedTessellatedItemAndRepresentationItemAndTessellatedGeometricSet tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 753:
	 {
		 DeclareAndCast(StepAP242_TessellatedSurfaceSet, anent, ent);
		 RWStepAP242_TessellatedSurfaceSet tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 754:
	 {
		 DeclareAndCast(StepAP242_ComplexTriangulatedSurfaceSet, anent, ent);
		 RWStepAP242_ComplexTriangulatedSurfaceSet tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 755:
	 {
		 ...
		 RWStepRepr_RWRealRepresentationItem tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 756:
	 {
		 DeclareAndCast(StepRepr_GeneralPropertyAssociation, anent, ent);
		 RWStepRepr_RWGeneralPropertyAssociation tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 757:
	 {
		 DeclareAndCast(StepAP242_TessellatedSurface, anent, ent);
		 RWStepAP242_TessellatedSurface tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 758:
	 {
		 DeclareAndCast(StepAP242_ComplexTriangulatedSurface, anent, ent);
		 RWStepAP242_ComplexTriangulatedSurface tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 759:
	 {
		 DeclareAndCast(StepAP242_TessellatedShell, anent, ent);
		 RWStepAP242_TessellatedShell tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 760:
	 {
		 DeclareAndCast(StepAP242_TessellatedSolid, anent, ent);
		 RWStepAP242_TessellatedSolid tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
	 case 761:
	 {
		 DeclareAndCast(StepAP242_TessellatedShapeRepresentation, anent, ent);
		 RWStepAP242_TessellatedShapeRepresentation tool;
		 tool.ReadStep(data, num, ach, anent);
	 }
	 break;
  default: 
