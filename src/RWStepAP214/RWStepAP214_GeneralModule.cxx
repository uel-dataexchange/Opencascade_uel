...
//    break;
  ...
  case 706:
   ...
   break;
   case 751:
	   ent = new StepAP242_RepositionedTessellatedItem;
	   break;
   case 752:
	   ent = new StepAP242_RepositionedTessellatedItemAndRepresentationItemAndTessellatedGeometricSet;
	   break;
   case 753:
	   ent = new StepAP242_TessellatedSurfaceSet;
	   break;
   case 754:
	   ent = new StepAP242_ComplexTriangulatedSurfaceSet;
	   break;
   case 755:
	   ent = new StepRepr_RealRepresentationItem;
	   break;
   case 756:
	   ent = new StepRepr_GeneralPropertyAssociation;
	   break;
   case 757:
	   ent = new StepAP242_TessellatedSurface();
	   break;
   case 758:
	   ent = new StepAP242_ComplexTriangulatedSurface();
	   break;
   case 759:
	   ent = new StepAP242_TessellatedShell();
	   break;
   case 760:
	   ent = new StepAP242_TessellatedSolid();
	   break;
   case 761:
	   ent = new StepAP242_TessellatedShapeRepresentation();
	   break;
  default: 
