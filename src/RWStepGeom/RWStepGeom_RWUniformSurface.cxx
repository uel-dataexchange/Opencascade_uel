...
#include <RWStepGeom_RWUniformSurface.ixx>
...
void RWStepGeom_RWUniformSurface::ReadStep
	 ...
	 const Handle(StepGeom_UniformSurface)& ent) const
{
	...
	if (!data->CheckNbParams(num,8,ach,"uniform_surface")) return;
...
void RWStepGeom_RWUniformSurface::WriteStep
...
void RWStepGeom_RWUniformSurface::Share(const Handle(StepGeom_UniformSurface)& ent, Interface_EntityIterator& iter) const
{
