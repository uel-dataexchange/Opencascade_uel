...
void RWStepGeom_RWSurfaceCurve::ReadStep
	(const Handle(StepData_StepReaderData)& data,
	 const Standard_Integer num,
	 Handle(Interface_Check)& ach,
	 const Handle(StepGeom_SurfaceCurve)& ent) const
{


	// --- Number of Parameter Control ---

	if (!data->CheckNbParams(num,4,ach,"surface_curve")) return;
...
void RWStepGeom_RWSurfaceCurve::WriteStep
...
void RWStepGeom_RWSurfaceCurve::Share(const Handle(StepGeom_SurfaceCurve)& ent, Interface_EntityIterator& iter) const
{
