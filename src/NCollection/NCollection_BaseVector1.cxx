...
//=======================================================================
//function : NCollection_BaseVector1::Iterator::copyV
//purpose  : Copy from another iterator
//=======================================================================

void NCollection_BaseVector1::Iterator::copyV (const NCollection_BaseVector1::Iterator& theOth)
{
...
void NCollection_BaseVector1::Iterator::initV (const NCollection_BaseVector1& theVector, Standard_Boolean theToEnd)
{
  myVector = &theVector;
...
NCollection_BaseVector1::MemBlock* NCollection_BaseVector1
...
void NCollection_BaseVector1::Clear()
{
  if (myLength > 0)
  {
...
void* NCollection_BaseVector1::expandV (const Standard_Integer theIndex)
{
  ...
  if (myCapacity < nNewBlock)
  {
    ...
    do myCapacity += GetCapacity1(myIncrement); while (myCapacity <= nNewBlock);
