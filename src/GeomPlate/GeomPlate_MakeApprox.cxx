...
class GeomPlate_MakeApprox_Evaluator : public AdvApp2Var_EvaluatorFunc2Var
{
public:
  GeomPlate_MakeApprox_Evaluator (Handle(Geom_Surface) a_fonct) :
      fonct(a_fonct) {}
...
//				Standard_Integer * ErrorCode)
//                        	// Error Code
void GeomPlate_MakeApprox_Evaluator::Evaluate(Standard_Integer * Dimension,
  Standard_Real    * UStartEnd,
  Standard_Real    * VStartEnd,
  Standard_Integer * FavorIso,// Choice of constante, 1 for U, 2 for V
  Standard_Real    * ConstParam,// Value of constant parameter
...
//POP pour WNT
  ...
  GeomPlate_MakeApprox_Evaluator ev(fonct);
