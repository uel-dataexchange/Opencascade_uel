...
IGESCAFControl_Writer::IGESCAFControl_Writer (const Standard_CString unit, const Standard_Integer modecr) :
		IGESControl_Writer(unit, modecr)
{
	myColorMode		= Standard_True;
	myNameMode		= Standard_True;
	myLayerMode		= Standard_True;
