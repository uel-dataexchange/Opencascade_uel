...
//=======================================================================
//function : RWStepAP242_ComplexTriangulatedSurfaceSet
//purpose  : 
//=======================================================================
RWStepAP242_ComplexTriangulatedSurfaceSet::RWStepAP242_ComplexTriangulatedSurfaceSet () {}

//=======================================================================
//function : ReadStep
//purpose  : 
//=======================================================================
void RWStepAP242_ComplexTriangulatedSurfaceSet::ReadStep
  (const Handle(StepData_StepReaderData)& data,
  const Standard_Integer num,
  Handle(Interface_Check)& ach,
  const Handle(StepAP242_ComplexTriangulatedSurfaceSet)& ent) const
{
  // Number of Parameter Control
  if (!data->CheckNbParams(num, 7, ach, "complex_triangulated_surface_set")) return;
  ...
  if (data->ReadSubList (num,5,"pnindex",ach,nsub2)) 
  {
	  Standard_Integer nb2 = data->NbParams(nsub2);
	  if (nb2 > 0) 
	  {
  ...
  if (data->ReadSubList (num,6,"triangle_strips",ach,nsub2)) 
  {
    Standard_Integer nb2 = data->NbParams(nsub2);
	if (nb2 > 0) {
  ...
  if (data->ReadSubList (num,7,"triangle_fans",ach,nsub2)) 
  {
    Standard_Integer nb2 = data->NbParams(nsub2);
	if (nb2 > 0)
	{
  ...
  ent->Init(aName, aCoordList, nPnMax, aNormals, aPnIndex, aTriangleStrips, aTriangleFans);
...
//purpose  : 
//=======================================================================
void RWStepAP242_ComplexTriangulatedSurfaceSet::WriteStep
...
//purpose  : 
//=======================================================================
void RWStepAP242_ComplexTriangulatedSurfaceSet::Share (const Handle(StepAP242_ComplexTriangulatedSurfaceSet) &ent,
