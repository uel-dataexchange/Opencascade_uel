...
//=======================================================================
//function : RWStepAP242_TessellatedSurfaceSet
//purpose  : 
//=======================================================================
RWStepAP242_TessellatedSurfaceSet::RWStepAP242_TessellatedSurfaceSet () {}

//=======================================================================
//function : ReadStep
//purpose  : 
//=======================================================================
void RWStepAP242_TessellatedSurfaceSet::ReadStep
  ...
  const Handle(StepAP242_TessellatedSurfaceSet)& ent) const
{
  ...
  if (!data->CheckNbParams(num, 4, ach, "tessellated_curve_set")) return;
  ...
  ent->Init(aName, aCoordList, nPnMax, aNormals);
...
//purpose  : 
//=======================================================================
void RWStepAP242_TessellatedSurfaceSet::WriteStep
...
//purpose  : 
//=======================================================================
void RWStepAP242_TessellatedSurfaceSet::Share (const Handle(StepAP242_TessellatedSurfaceSet) &ent,
