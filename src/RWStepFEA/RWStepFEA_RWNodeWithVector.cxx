// File:	RWStepFEA_RWNodeWithVector.cxx
...
void RWStepFEA_RWNodeWithVector::ReadStep (const Handle(StepData_StepReaderData)& data,
                                           const Standard_Integer num,
                                           Handle(Interface_Check)& ach,
                                           const Handle(StepFEA_NodeWithVector) &ent) const
{
  // Check number of parameters
  if ( ! data->CheckNbParams(num,4,ach,"node_with_vector") ) return;
...
void RWStepFEA_RWNodeWithVector::Share (const Handle(StepFEA_NodeWithVector) &ent,
