// File:	RWStepFEA_RWDummyNode.cxx
...
void RWStepFEA_RWDummyNode::ReadStep (const Handle(StepData_StepReaderData)& data,
                                      const Standard_Integer num,
                                      Handle(Interface_Check)& ach,
                                      const Handle(StepFEA_DummyNode) &ent) const
{
  // Check number of parameters
  if ( ! data->CheckNbParams(num,4,ach,"dummy_node") ) return;
...
void RWStepFEA_RWDummyNode::WriteStep (StepData_StepWriter& SW,
                                       const Handle(StepFEA_DummyNode) &ent) const
{
...
void RWStepFEA_RWDummyNode::Share (const Handle(StepFEA_DummyNode) &ent,
