...
IMPLEMENT_STANDARD_RTTIEXT_1(XCAFDoc_ViewTool, TDF_Attribute)
...
//purpose  : 
//=======================================================================
void XCAFDoc_ViewTool::GetViewLabels(TDF_LabelSequence1& theLabels) const
{
  theLabels.Clear();
...
//purpose  : 
//=======================================================================
void XCAFDoc_ViewTool::SetView(const TDF_LabelSequence1& theShapes,
...
//purpose  : 
//=======================================================================
void XCAFDoc_ViewTool::SetView(const TDF_LabelSequence1& theShapeLabels,
                               const TDF_LabelSequence1& theGDTLabels,
                               const TDF_LabelSequence1& theClippingPlaneLabels,
                               const TDF_Label& theViewL) const
{
  if(!IsView(theViewL))
    return;
...
//purpose  : 
//=======================================================================
void XCAFDoc_ViewTool::SetClippingPlanes(const TDF_LabelSequence1& theClippingPlaneLabels,
  const TDF_Label& theViewL) const
{
  if (!IsView(theViewL))
    return;
...
Standard_Boolean XCAFDoc_ViewTool::GetRefShapeLabel(const TDF_Label& theViewL,
                                                    TDF_LabelSequence1& theShapeLabels) const
{
...
Standard_Boolean XCAFDoc_ViewTool::GetRefGDTLabel(const TDF_Label& theViewL,
                                                  TDF_LabelSequence1& theGDTLabels) const
{
  theGDTLabels.Clear();
  Handle(TDataStd_TreeNode) aNode;
  if( !theViewL.FindAttribute(XCAFDoc::ViewRefGUID(), aNode) || !aNode->HasFather() ) {
...
Standard_Boolean XCAFDoc_ViewTool::GetRefClippingPlaneLabel(const TDF_Label& theViewL,
  TDF_LabelSequence1& theClippingPlaneLabels) const
{
...
Standard_Boolean XCAFDoc_ViewTool::GetRefNoteLabel(const TDF_Label& theViewL,
  TDF_LabelSequence1& theNoteLabels) const
{
  theNoteLabels.Clear();
  Handle(TDataStd_TreeNode) aNode;
  if (!theViewL.FindAttribute(XCAFDoc::ViewRefGUID(), aNode) || !aNode->HasFather()) {
...
Standard_Boolean XCAFDoc_ViewTool::GetRefAnnotationLabel(const TDF_Label& theViewL,
  TDF_LabelSequence1& theAnnotationLabels) const
{
...
Standard_Boolean XCAFDoc_ViewTool::GetViewLabelsForShape(const TDF_Label& theShapeL,
                                                         TDF_LabelSequence1& theViews) const
{
  Handle(XCAFDoc_GraphNode) aGNode;
