...
IMPLEMENT_STANDARD_RTTIEXT_1(XCAFDoc_AssemblyItemRef, TDF_Attribute)
...
XCAFDoc_AssemblyItemRef::IsOrphan() const
{
  ...
  if (HasExtraRef())
  {
    ...
    else if (IsSubshapeIndex())
    {
      ...
      if (aSubshapeIndex < 1 || aMap.Extent() < aSubshapeIndex)
        return Standard_True;
    }
  }
...
void
XCAFDoc_AssemblyItemRef::SetItem(const TColStd_ListOfAsciiString1& thePath)
{
  Backup();
