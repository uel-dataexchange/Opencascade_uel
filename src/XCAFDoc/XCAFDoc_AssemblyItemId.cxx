...
XCAFDoc_AssemblyItemId::XCAFDoc_AssemblyItemId(const TColStd_ListOfAsciiString1& thePath)
{
  Init(thePath);
}
...
void 
XCAFDoc_AssemblyItemId::Init(const TColStd_ListOfAsciiString1& thePath)
{
  myPath = thePath;
}
...
XCAFDoc_AssemblyItemId::IsChild(const XCAFDoc_AssemblyItemId& theOther) const
{
  ...
  TColStd_ListOfAsciiString1::Iterator anIt(myPath), anItOther(theOther.myPath);
...
const 
TColStd_ListOfAsciiString1& XCAFDoc_AssemblyItemId::GetPath() const
{
  return myPath;
}
...
XCAFDoc_AssemblyItemId::ToString() const
{
  ...
  for (TColStd_ListOfAsciiString1::Iterator anIt(myPath); anIt.More(); anIt.Next())
  {
    aStr += '/';
    aStr += anIt.Value();
  }
