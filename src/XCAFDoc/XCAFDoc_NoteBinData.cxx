...
IMPLEMENT_STANDARD_RTTIEXT_1(XCAFDoc_NoteBinData, XCAFDoc_Note)
                         ...
                         OSD_File&                         theFile)
{
  ...
  if (theFile.Size() > (Standard_Size)IntegerLast())
    return Standard_False;
  myData.Nullify();
  myData = new TColStd_HArray1OfByte1(1, (Standard_Integer)theFile.Size());
  //myData.reset(new TColStd_HArray1OfByte1(1, (Standard_Integer)theFile.Size()));
  Standard_Integer nbReadBytes = 0;
  theFile.Read1((Standard_Address)&myData->First(), myData->Length(), nbReadBytes);
