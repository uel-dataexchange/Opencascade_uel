...
IMPLEMENT_STANDARD_RTTIEXT_1(XCAFDoc_NotesTool, TDF_Attribute)
...
// =======================================================================
void
XCAFDoc_NotesTool::GetNotes(TDF_LabelSequence1& theNoteLabels) const
{
  for (TDF_ChildIterator anIter(GetNotesLabel()); anIter.More(); anIter.Next())
  {
    const TDF_Label aLabel = anIter.Value();
...
// =======================================================================
void
XCAFDoc_NotesTool::GetAnnotatedItems(TDF_LabelSequence1& theItemLabels) const
{
  for (TDF_ChildIDIterator anIter(GetAnnotatedItemsLabel(), XCAFDoc_AssemblyItemRef::GetID()); anIter.More(); anIter.Next())
  {
...
XCAFDoc_NotesTool::CreateBinData(const TCollection_ExtendedString&    theUserName,
                                 ...
                                 const TCollection_ExtendedString&    theTitle,
                                 const TCollection_AsciiString&       theMIMEtype,
                                 const Handle(TColStd_HArray1OfByte1)& theData)
{
  TDF_Label aNoteLabel;
  TDF_TagSource aTag;
  aNoteLabel = aTag.NewChild(GetNotesLabel());
...
// =======================================================================
Standard_Integer
XCAFDoc_NotesTool::DeleteNotes(TDF_LabelSequence1& theNoteLabels)
{
  Standard_Integer nbNotes = 0;
  for (TDF_LabelSequence1::Iterator anIter(theNoteLabels); anIter.More(); anIter.Next())
  {
...
// =======================================================================
void
XCAFDoc_NotesTool::GetOrphanNotes(TDF_LabelSequence1& theNoteLabels) const
{
  for (TDF_ChildIterator anIter(GetNotesLabel()); anIter.More(); anIter.Next())
  {
    const TDF_Label aLabel = anIter.Value();
