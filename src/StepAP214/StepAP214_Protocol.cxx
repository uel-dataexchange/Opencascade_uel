...
IMPLEMENT_STANDARD_RTTIEXT_1(StepAP214_Protocol,StepData_Protocol)
...
//  types.Bind (STANDARD_TYPE(StepFEA_SymmetricTensor43d),563);
  ...
  types.Bind (STANDARD_TYPE(StepAP242_RepositionedTessellatedItem), 751);
  types.Bind (STANDARD_TYPE(StepAP242_RepositionedTessellatedItemAndRepresentationItemAndTessellatedGeometricSet), 752);
  types.Bind (STANDARD_TYPE(StepAP242_TessellatedSurfaceSet), 753);
  types.Bind (STANDARD_TYPE(StepAP242_ComplexTriangulatedSurfaceSet), 754);
  types.Bind(STANDARD_TYPE(StepRepr_RealRepresentationItem), 755);
  types.Bind(STANDARD_TYPE(StepRepr_GeneralPropertyAssociation), 756);
  types.Bind(STANDARD_TYPE(StepAP242_TessellatedSurface), 757);
  types.Bind(STANDARD_TYPE(StepAP242_ComplexTriangulatedSurface), 758);
  types.Bind(STANDARD_TYPE(StepAP242_TessellatedShell), 759);
  types.Bind(STANDARD_TYPE(StepAP242_TessellatedSolid), 760);
  types.Bind(STANDARD_TYPE(StepAP242_TessellatedShapeRepresentation), 761);
